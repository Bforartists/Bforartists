...
class TOOLBAR_PT_type(Panel):
    ...
    def draw(self, context):
        ...
        row.alignment = 'CENTER'
        row.prop(bpy.context.scene, 'bfa_toolbar_defaults', text="", icon='OPTIONS', emboss=True)
    ...
    def draw_menus(layout, context):
        ...
        ## ------------------ image sub toolbars
            ...
            if addon_prefs.image_uv_align:
                ...
                row.operator("uv.align", text="", icon="ALIGNX").axis = 'ALIGN_X'
                row.operator("uv.align", text="", icon="ALIGNY").axis = 'ALIGN_Y'
