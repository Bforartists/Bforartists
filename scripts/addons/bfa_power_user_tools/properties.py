...
class BFA_UI_toggles(bpy.types.PropertyGroup):
    BFA_PROP_toggle_insertkeyframes: bpy.props.BoolProperty(name='Insert/Remove Keyframes', description='Adds operators to insert/remove a frame to the left or right of the timeline cursor.\nLocated in the 3D View, Timeline, Dopesheet, and Graph editors', default=True)
