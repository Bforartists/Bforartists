...
translations_tuple = (
    (("*", ""),
     ((), ()),
     ("fr_FR", "Project-Id-Version: Sun Position 3.5.5 (0)\n",
               (False,
    ...
    (("*", "Elevation"),
     (("bpy.types.SunPosProperties.hdr_elevation",
       "scripts/addons/sun_position/ui_sun.py:184"),
      ()),
     ("fr_FR", "Hauteur",
               (False, ())),
    ),
    ...
    (("*", "North Offset"),
     (("bpy.types.SunPosProperties.north_offset",
       "scripts/addons/sun_position/ui_sun.py:180"),
      ()),
    ...
    (("*", "Unknown projection"),
     (("scripts/addons/sun_position/hdr.py:170",),
      ()),
    ...
    (("*", "Show options and info:"),
     (("scripts/addons/sun_position/properties.py:341",),
      ()),
     ("fr_FR", "Afficher les options et infos :",
               (False, ())),
    ),
    (("Hour", "Time"),
     (("scripts/addons/sun_position/ui_sun.py:223",),
      ()),
     ("fr_FR", "Heure",
               (False, ())),
    ),
    (("*", "Time Local:"),
     (("scripts/addons/sun_position/ui_sun.py:240",),
      ()),
     ("fr_FR", "Heure locale :",
               (False, ())),
    ),
    ...
    (("*", "Please select World in the World panel."),
     (("scripts/addons/sun_position/ui_sun.py:97",
       "scripts/addons/sun_position/ui_sun.py:139"),
      ()),
     ("fr_FR", "Veuillez sélectionner le monde dans le panneau Monde",
               (False, ())),
    ),
    (("*", "Show"),
     (("scripts/addons/sun_position/ui_sun.py:143",),
      ()),
     ("fr_FR", "Afficher",
               (False, ())),
    ),
    ...
    (("*", "Use"),
     (("scripts/addons/sun_position/ui_sun.py:149",),
      ()),
     ("fr_FR", "Utiliser",
               (False, ())),
    ),
    ...
    (("*", "Sunrise:"),
     (("scripts/addons/sun_position/ui_sun.py:258",),
      ()),
     ("fr_FR", "Lever :",
               (False, ())),
    ),
    ...
    (("*", "Please activate Use Nodes in the World panel."),
     (("scripts/addons/sun_position/ui_sun.py:94",
       "scripts/addons/sun_position/ui_sun.py:136"),
      ()),
