...
def register():
    ...
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.append(seperator) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.append(ops.BFA_OT_insertframe_left.menu_func) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.append(ops.BFA_OT_removeframe_left.menu_func) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.append(seperator) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.append(ops.BFA_OT_insertframe_right.menu_func) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.append(ops.BFA_OT_removeframe_right.menu_func) # BFA - TODO - Fix in own task
...
def unregister():
    ...
    ## 3D View Editor - Grease Pencil
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.remove(seperator)  # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.remove(ops.BFA_OT_insertframe_left.menu_func) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.remove(ops.BFA_OT_removeframe_left.menu_func) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.remove(seperator) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.remove(ops.BFA_OT_insertframe_right.menu_func) # BFA - TODO - Fix in own task
    # bpy.types.VIEW3D_MT_edit_greasepencil_animation.remove(ops.BFA_OT_removeframe_right.menu_func) # BFA - TODO - Fix in own task
