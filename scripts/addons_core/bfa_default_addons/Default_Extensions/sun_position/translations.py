...
translations_tuple = (
    (("*", ""),
     ((), ()),
     ("fr_FR", "Project-Id-Version: Sun Position 4.0.0 (0)\n",
               (False,
    ...
    (("*", "Refraction"),
     (("bpy.types.SunPosAddonPreferences.show_refraction",
       "extensions/UserRepository/sun_position/ui_sun.py:150"),
      ()),
     ("fr_FR", "Réfraction",
               (False, ())),
    ),
    ...
    (("*", "Bind Texture to Sun"),
     (("bpy.types.SunPosProperties.bind_to_sun",
       "extensions/UserRepository/sun_position/ui_sun.py:103"),
      ()),
    ...
    (("*", "Elevation"),
     (("bpy.types.SunPosProperties.env_elevation",
       "extensions/UserRepository/sun_position/ui_sun.py:184"),
      ()),
     ("fr_FR", "Hauteur",
               (False, ())),
    ),
    ...
    (("*", "North Offset"),
     (("bpy.types.SunPosProperties.north_offset",
       "extensions/UserRepository/sun_position/ui_sun.py:180"),
      ()),
    ...
    (("*", "Enter/LMB: confirm, Esc/RMB: cancel, MMB: pan, mouse wheel: zoom, Ctrl + mouse wheel: set exposure"),
     (("extensions/UserRepository/sun_position/environment.py:269",),
      ()),
     ("fr_FR", "Entrée/ClicG : Confirmer, Échap/ClicD : Annuler, ClicM : défiler, molette : zoom, Ctrl + molette : exposition",
               (False, ())),
    ),
    (("*", "Unknown projection"),
     (("extensions/UserRepository/sun_position/environment.py:170",),
      ()),
     ("fr_FR", "Projection inconnue",
               (False, ())),
    ),
    (("*", "ERROR: Could not parse coordinates"),
     (("extensions/UserRepository/sun_position/properties.py:36",),
      ()),
     ("fr_FR", "ERREUR : Impossible d’analyser les coordonnées",
               (False, ())),
    ),
    (("*", "Show options and info:"),
     (("extensions/UserRepository/sun_position/properties.py:341",),
      ()),
     ("fr_FR", "Afficher les options et infos :",
               (False, ())),
    ),
    (("Hour", "Time"),
     (("extensions/UserRepository/sun_position/ui_sun.py:223",),
      ()),
     ("fr_FR", "Heure",
               (False, ())),
    ),
    (("*", "Time Local:"),
     (("extensions/UserRepository/sun_position/ui_sun.py:240",),
      ()),
     ("fr_FR", "Heure locale :",
               (False, ())),
    ),
    (("*", "UTC:"),
     (("extensions/UserRepository/sun_position/ui_sun.py:241",),
      ()),
     ("fr_FR", "UTC :",
               (False, ())),
    ),
    (("*", "Please select World in the World panel."),
     (("extensions/UserRepository/sun_position/ui_sun.py:97",
       "extensions/UserRepository/sun_position/ui_sun.py:139"),
      ()),
     ("fr_FR", "Veuillez sélectionner le monde dans le panneau Monde",
               (False, ())),
    ),
    (("*", "Show"),
     (("extensions/UserRepository/sun_position/ui_sun.py:143",),
      ()),
     ("fr_FR", "Afficher",
               (False, ())),
    ),
    (("*", "North"),
     (("extensions/UserRepository/sun_position/ui_sun.py:144",),
      ()),
     ("fr_FR", "Nord",
               (False, ())),
    ),
    (("*", "Analemmas"),
     (("extensions/UserRepository/sun_position/ui_sun.py:145",),
      ()),
     ("fr_FR", "Analemmes",
               (False, ())),
    ),
    (("*", "Surface"),
     (("extensions/UserRepository/sun_position/ui_sun.py:146",),
      ()),
     ("fr_FR", "Surface",
               (False, ())),
    ),
    (("*", "Use"),
     (("extensions/UserRepository/sun_position/ui_sun.py:149",),
      ()),
     ("fr_FR", "Utiliser",
               (False, ())),
    ),
    (("*", "Azimuth"),
     (("extensions/UserRepository/sun_position/ui_sun.py:185",),
      ()),
     ("fr_FR", "Azimut",
               (False, ())),
    ),
    (("*", "Sunrise:"),
     (("extensions/UserRepository/sun_position/ui_sun.py:258",),
      ()),
     ("fr_FR", "Lever :",
               (False, ())),
    ),
    (("*", "Sunset:"),
     (("extensions/UserRepository/sun_position/ui_sun.py:259",),
      ()),
     ("fr_FR", "Coucher :",
               (False, ())),
    ),
    (("*", "Please activate Use Nodes in the World panel."),
     (("extensions/UserRepository/sun_position/ui_sun.py:94",
       "extensions/UserRepository/sun_position/ui_sun.py:136"),
      ()),
