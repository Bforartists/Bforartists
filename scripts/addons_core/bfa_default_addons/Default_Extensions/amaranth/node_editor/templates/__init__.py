...
import bpy
from ...node_editor.templates.vectorblur import AMTH_NODE_OT_AddTemplateVectorBlur
from ...node_editor.templates.vignette import AMTH_NODE_OT_AddTemplateVignette
