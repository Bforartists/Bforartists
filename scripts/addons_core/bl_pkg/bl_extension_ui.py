...
def addons_panel_draw_items(
    ...
    for mod in addon_modules:
        ...
        if item_warnings:
            row.active = True # BFA - Float right
            row_right.alignment = 'RIGHT'# BFA - Float right
    ...
    if show:
        ...
        if is_installed:
            ...
            if is_system_repo:
                ...
                row_right.operator("extensions.package_uninstall_system", text="Uninstall", icon='CANCEL') # BFA - icon added
            else:
                row_right.active = True
                row_right.alignment = 'RIGHT'
...
class USERPREF_MT_extensions_item(Menu):
    ...
    def draw(self, context):
        ...
        ## BFA - displayed at a top level now - START ##
        #if is_installed:
        #    layout.separator()
        #
        #    if is_system_repo:
        ...
        #        props.pkg_id = pkg_id
        #        del props
        ## BFA - displayed at a top level now - END ##
