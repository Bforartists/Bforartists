...
void view_clipping_distances([[maybe_unused]] float3 wpos)
{
  ...
  /* WORKAROUND(fclem): Allow both legacy and SRT codepath to coexist.
   * Metal backend checks fFor this exact condition to declare gl_ClipDistance and not pay the
