...
static void panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  if (RNA_boolean_get(ptr, "use_normal")) {
    row->prop(ptr, "use_normal_x", ui::ITEM_R_TOGGLE, IFACE_("X"), ICON_NONE);
    row->prop(ptr, "use_normal_y", ui::ITEM_R_TOGGLE, IFACE_("Y"), ICON_NONE);
    row->prop(ptr, "use_normal_z", ui::ITEM_R_TOGGLE, IFACE_("Z"), ICON_NONE);
