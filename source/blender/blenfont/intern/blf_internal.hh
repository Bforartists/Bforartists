...
void blf_draw_svg_icon(FontBLF *font,
                       ...
                       bool multicolor = false); /* BFA - need to see where this is applied for */

blender::Array<uchar> blf_svg_icon_bitmap(
    FontBLF *font, uint icon_id, float size, int *r_width, int *r_height, bool multicolor = false); /* BFA - need to see where this is applied for */
