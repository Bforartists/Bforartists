...
static GlyphBLF *blf_glyph_cache_add_svg(GlyphCacheBLF *gc, uint charcode, bool color) /*bfa - icon  colorpatch*/
{
  ...
  const int dest_w = int(ceil(image->width * scale + 1.00)); /*BFA - added a 1px padding to center default icons*/
