...
enum {
  ...
  SNODE_GIZMO_HIDE_NAVIGATE = (1 << 2),
  SNODE_GIZMO_SHOW_MINIMAP = (1 << 3),
  SNODE_GIZMO_MINIMAP_USE_NODE_COLORS = (1 << 4),
  SNODE_GIZMO_MINIMAP_USE_FRAME_COLORS = (1 << 5),
  SNODE_GIZMO_MINIMAP_SHOW_NODES_IN_FRAME = (1 << 6),
  SNODE_GIZMO_MINIMAP_MOVE_TO_TOP = (1 << 7),
  SNODE_GIZMO_MINIMAP_AUTO_HIDE = (1 << 8),
};
