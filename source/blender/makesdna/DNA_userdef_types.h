...
enum eUserpref_OutlinerEditorFlags : int {
...
struct UserDef {
 ...
 eUserPref_Flag flag = USER_AUTOSAVE | USER_TOOLTIPS | USER_RELPATHS | USER_RELEASECONFIRM |
  ...
  eUserpref_UI_Flag2 uiflag2 = USER_REGION_OVERLAP | USER_NODE_AUTOPOSITION_VIEWER |
                               USER_ALWAYS_SHOW_NUMBER_ARROWS | USER_UIFLAG2_SHOW_ONLINE_ASSETS;
