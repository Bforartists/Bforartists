...
struct ScrArea {
  ...
  char do_refresh = 0;
  char _pad2[2] = {};  // bfa - padding because eScrArea_Flag is now int (4 bytes)
  eScrArea_Flag flag = {};
  
  /** bfa - our own toolbar flag */
  char toolbar_flag = 0;
  char _pad0[1] = {};  // bfa - padding to align region_active_win
  ...
  char _pad[4] = {};  // bfa - padding to align *type to 8 bytes
...
enum eRegion_Flag : short {
  ...
  RGN_FLAG_HIDE_CATEGORY_TABS = (1 << 14),
};
