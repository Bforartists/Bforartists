...
static void rna_def_movieclipUser(BlenderRNA *brna)
{
  ...
  RNA_def_struct_ui_text(
      srna,
      "Movie Clip User",
      "Parameters defining how a MovieClip data is used by another data"); /* BFA */
...
static void rna_def_movieclip(BlenderRNA *brna)
{
  ...
  RNA_def_struct_ui_text(srna, "MovieClip", "MovieClip data referencing an external movie file"); /* BFA */
