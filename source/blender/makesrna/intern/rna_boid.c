...
const EnumPropertyItem rna_enum_boidrule_type_items[] = {
    ...
    {eBoidRuleType_AvoidCollision,
     ...
     "near future"},
    {eBoidRuleType_Separate, "SEPARATE", ICON_SEPARATE, "Separate", "Keep from going through other boids"},
    {eBoidRuleType_Flock,
     "FLOCK",
     ICON_FLOCK,
     "Flock",
    ...
    {eBoidRuleType_Fight, "FIGHT", ICON_FIGHT, "Fight", "Go to closest enemy and attack when in range"},
#if 0
