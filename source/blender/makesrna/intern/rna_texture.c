...
const EnumPropertyItem rna_enum_texture_type_items[] = {
	...
	{TEX_CLOUDS, "CLOUDS", ICON_CLOUD_TEX, "Clouds", "Procedural - create a cloud-like fractal noise texture"},
	{TEX_DISTNOISE, "DISTORTED_NOISE", ICON_DISTORTED_NOISE_TEX, "Distorted Noise", "Procedural - noise texture distorted by two noise algorithms"},
	{TEX_IMAGE, "IMAGE", ICON_IMAGE_DATA, "Image or Movie", "Allow for images or movies to be used as textures"},
	{TEX_MAGIC, "MAGIC", ICON_MAGIC_TEX, "Magic", "Procedural - color texture based on trigonometric functions"},
	{TEX_MARBLE, "MARBLE", ICON_MARBLE_TEX, "Marble", "Procedural - marble-like noise texture with wave generated bands"},
	{TEX_MUSGRAVE, "MUSGRAVE", ICON_MUSGRAVE_TEX, "Musgrave", "Procedural - highly flexible fractal noise texture"},
	{TEX_NOISE, "NOISE", ICON_NOISE_TEX, "Noise", "Procedural - random noise, gives a different result every time, for every frame, for every pixel"},
	{TEX_STUCCI, "STUCCI", ICON_STUCCI_TEX, "Stucci", "Procedural - create a fractal noise texture"},
	{TEX_VORONOI, "VORONOI", ICON_VORONI_TEX, "Voronoi", "Procedural - create cell-like patterns based on Worley noise"},
	{TEX_WOOD, "WOOD", ICON_WOOD_TEX, "Wood", "Procedural - wave generated bands or rings, with optional noise"},
	{0, NULL, 0, NULL, NULL},
};
