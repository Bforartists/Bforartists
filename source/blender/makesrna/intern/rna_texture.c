...
const EnumPropertyItem rna_enum_texture_type_items[] = {
	...
	{ TEX_ENVMAP, "ENVIRONMENT_MAP", ICON_ENVIRONMENT_TEX,
	...
	{TEX_NOISE, "NOISE", ICON_NOISE_TEX, "Noise",
	            "Procedural - random noise, gives a different result every time, for every frame, for every pixel"},
	{TEX_OCEAN, "OCEAN", ICON_OCEAN_TEX, "Ocean", "Use a texture generated by an Ocean modifier"},
	{TEX_POINTDENSITY, "POINT_DENSITY", ICON_POINT_DENSITY_TEX, "Point Density", ""},
