                                                                 ...
                                                                 bool *r_free)
{
  ...
  /*bfa -  this new blender code collides with our features. We have removed the tools tab
  from the properties editor. And this new code produces a crash to desktop*/
  ...
  //  }
  //}
  /*bfa - end not working blender code*/
