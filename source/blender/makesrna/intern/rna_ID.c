...
#  endif
  ...
  RNA_def_struct_ui_text(srna, "ID Property Group", "ID Property Group\nGroup of ID properties");
...
static void rna_def_ID_materials(BlenderRNA *brna)
{
  ...
  RNA_def_struct_ui_text(srna, "ID Materials", "ID Materials\nCollection of materials");
...
static void rna_def_image_preview(BlenderRNA *brna)
{
  ...
  RNA_def_struct_ui_text(srna, "Image Preview", "Image Preview\nPreview image and icon");
  ...
  RNA_def_property_ui_text(prop, "Image Pixels", "Image Pixels\nImage pixels, as bytes (always RGBA 32bits)");
  ...
  RNA_def_property_flag(prop, PROP_DYNAMIC);
  RNA_def_property_multi_array(prop, 1, NULL);
  RNA_def_property_ui_text(prop, "Icon Pixels", "Icon Pixels\nIcon pixels, as bytes (always RGBA 32bits)");
...
static void rna_def_ID(BlenderRNA *brna)
{
  ...
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  RNA_def_property_ui_text(prop, "Users", "Users\nNumber of times this data-block is referenced");

  prop = RNA_def_property(srna, "use_fake_user", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "flag", LIB_FAKEUSER);
  RNA_def_property_ui_text(prop, "Fake User", "Fake User\nSave this data-block even if it has no users");
  ...
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  RNA_def_property_ui_text(prop, "Is Indirect", "Is Indirect\nIs this ID block linked indirectly");

  prop = RNA_def_property(srna, "library", PROP_POINTER, PROP_NONE);
  RNA_def_property_pointer_sdna(prop, NULL, "lib");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  RNA_def_property_ui_text(prop, "Library", "Library\nLibrary file the data-block is linked from");
