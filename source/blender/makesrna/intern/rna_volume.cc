...
const EnumPropertyItem rna_enum_volume_grid_data_type_items[] = {
    ...
    {VOLUME_GRID_MASK, "MASK", ICON_NODE_SOCKET_BOOLEAN, "Mask", "No data, boolean mask of active voxels"},
    {VOLUME_GRID_VECTOR_FLOAT, "VECTOR_FLOAT", ICON_NODE_SOCKET_VECTOR, "Vector", "3D float vector"},
    {VOLUME_GRID_VECTOR_DOUBLE, "VECTOR_DOUBLE", ICON_NODE_SOCKET_VECTOR, "Double Vector", "3D double vector"},
    {VOLUME_GRID_VECTOR_INT, "VECTOR_INT", ICON_NODE_SOCKET_INT, "Integer Vector", "3D integer vector"},
    {VOLUME_GRID_POINTS,
     "POINTS",
     0,
     "Points (Unsupported)",
...
static void rna_def_volume(BlenderRNA *brna)
{
  ...
  RNA_def_struct_ui_text(srna, "Volume", "Volume data for 3D volume grids"); /* BFA */
  RNA_def_struct_ui_icon(srna, ICON_VOLUME_DATA);
  ...
  RNA_def_property_flag(prop, PROP_PATH_SUPPORTS_BLEND_RELATIVE);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(prop, "File Path", "Volume file used by this Volume"); /* BFA */
