...
const EnumPropertyItem rna_enum_attribute_type_items[] = {
    ...
    {CD_PROP_FLOAT3, "FLOAT_VECTOR", ICON_NODE_SOCKET_VECTOR, "Vector", "3D vector with floating-point values"},
    {CD_PROP_COLOR, "FLOAT_COLOR", ICON_NODE_SOCKET_RGBA, "Color", "RGBA color with 32-bit floating-point values"},
    {CD_PROP_QUATERNION, "QUATERNION", ICON_NODE_SOCKET_ROTATION, "Quaternion", "Floating point quaternion rotation"},
    ...
    {CD_PROP_INT8, "INT8", ICON_NODE_SOCKET_INT, "8-Bit Integer", "Smaller integer with a range from -128 to 127"},
    {CD_PROP_INT16_2D, "INT16_2D", ICON_NODE_SOCKET_INT, "2D 16-Bit Integer Vector", "16-bit signed integer vector"},
    {CD_PROP_INT32_2D, "INT32_2D", ICON_NODE_SOCKET_INT, "2D Integer Vector", "32-bit signed integer vector"},
    {CD_PROP_FLOAT2, "FLOAT2", ICON_NODE_SOCKET_VECTOR, "2D Vector", "2D vector with floating-point values"},
    {CD_PROP_FLOAT4, "FLOAT4", ICON_NODE_SOCKET_VECTOR, "4D Vector", "4D vector with floating-point values"},
    {CD_PROP_BYTE_COLOR,
     "BYTE_COLOR",
...
const EnumPropertyItem rna_enum_attribute_type_with_auto_items[] = {
    {CD_AUTO_FROM_NAME, "AUTO", ICON_NODE_STRUCTURE_AUTO, "Auto", ""},
    {CD_PROP_FLOAT, "FLOAT", ICON_NODE_SOCKET_FLOAT, "Float", "Floating-point value"},
    {CD_PROP_INT32, "INT", ICON_NODE_SOCKET_INT, "Integer", "32-bit integer"},
    {CD_PROP_BOOL, "BOOLEAN", ICON_NODE_SOCKET_BOOLEAN, "Boolean", "True or false"},
    {CD_PROP_FLOAT3, "FLOAT_VECTOR", ICON_NODE_SOCKET_VECTOR, "Vector", "3D vector with floating-point values"},
