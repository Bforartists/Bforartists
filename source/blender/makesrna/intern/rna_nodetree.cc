...
static void rna_def_nodes(BlenderRNA *brna)
{
  const auto define = [&](const char *base_name,
                          ...
                          int ui_icon = ICON_NONE,  /* BFA - accept icon param */
                          const char *ui_desc = "") /* BFA - accept ui_desc param */
  {
  ...
  define("NodeInternal", "NodeFrame", def_frame, ICON_NODE_FRAME, "Add a frame\nA frame allows to collect nodes together.\nUseful for organization when the re-usability of a node group is not required");
  define("NodeInternal", "NodeGroup", def_group, ICON_NODE_MAKEGROUP, "Create a node group from the selected nodes");
  define("NodeInternal", "NodeGroupInput", def_group_input, ICON_GROUPINPUT, "Add a Group Input node\nExpose connected data from inside a node group as inputs to its interface");
  define("NodeInternal", "NodeGroupOutput", def_group_output, ICON_GROUPOUTPUT, "Add a Group Output node\nOutput data from inside of a node group");
  define("NodeInternal", "NodeReroute", def_reroute, ICON_NODE_REROUTE, "Add a reroute point\nReroute points can be used to reroute connections for organization\nSupports one input and multiple outputs");

  define("ShaderNode", "ShaderNodeAddShader", nullptr, ICON_NODE_ADD_SHADER, "Add a Add Shader Shader node\nAdds two Shaders together");
  define("ShaderNode", "ShaderNodeAmbientOcclusion", def_sh_ambient_occlusion, ICON_NODE_AMBIENT_OCCLUSION, "Add a Ambient Occlusion Shader node\nAmbient Occlusion is a technique to self shadow the geometry of objects");
  define("ShaderNode", "ShaderNodeAttribute", def_sh_attribute, ICON_NODE_ATTRIBUTE, "Add a Attribute Shader node\nAllows you to retrieve attributes attached to an object or mesh");
  define("ShaderNode", "ShaderNodeBackground", nullptr, ICON_NODE_BACKGROUNDSHADER, "Add a Background Shader node\nAdd background light emission");
  define("ShaderNode", "ShaderNodeBevel", def_sh_bevel, ICON_BEVEL, "Add a Bevel Shader node\nRender rounded corners to capture specular highlights");
  define("ShaderNode", "ShaderNodeBlackbody", nullptr, ICON_NODE_BLACKBODY, "Add a Blackbody Shader node\nConverts a blackbody temperature to RGB value");
  define("ShaderNode", "ShaderNodeBrightContrast", nullptr, ICON_BRIGHTNESS_CONTRAST, "Add a Bright/Contrast Shader node\nControl the brightness and contrast of the input color");
  define("ShaderNode", "ShaderNodeBsdfAnisotropic", def_glossy, ICON_NODE_GLOSSYSHADER, "Add a Glossy BSDF Shader node\nnAdds an anisotropic reflection with micro facet distribution");
  define("ShaderNode", "ShaderNodeBsdfDiffuse", nullptr, ICON_NODE_DIFFUSESHADER, "Add a Diffuse BSDF Shader node\nLambertian and Oren-Nayar diffuse reflection");
  define("ShaderNode", "ShaderNodeBsdfGlass", def_glass, ICON_NODE_GLASSHADER, "Add a Glass BSDF Shader node\nA glass shader");
  define("ShaderNode", "ShaderNodeBsdfHair", def_hair, ICON_CURVES, "Add a Hair BSDF Shader node\nAdd shading for Hair");
  define("ShaderNode", "ShaderNodeBsdfHairPrincipled", def_hair_principled, ICON_CURVES, "Add a Principled Hair BSDF Shader node\nShading for Hair and Fur");
  define("ShaderNode", "ShaderNodeBsdfMetallic", def_metallic, ICON_METALLIC, "Add a Metallic BSDF Shader node\nMetallic reflection with microfacet distribution, and metallic fresnel");
  define("ShaderNode", "ShaderNodeBsdfPrincipled", def_principled, ICON_NODE_PRINCIPLED, "Add a Principled BSDF Shader node\nPhysically-based, easy-to-use combined shader node for rendering surface materials.\n Based on the Disney principled model also known as the PBR Shader");
  define("ShaderNode", "ShaderNodeBsdfRayPortal", nullptr, ICON_NONE, "Add a Ray Portal BSDF Shader node\nContinue tracing from an arbitrary new position and in a new direction");
  define("ShaderNode", "ShaderNodeBsdfRefraction", def_refraction, ICON_NODE_REFRACTIONSHADER, "Add a Refraction BSDF Shader node\nAdds glossy refraction with sharp or micro facet distribution");
  define("ShaderNode", "ShaderNodeBsdfSheen", def_sheen, ICON_NODE_VELVET, "Add a Sheen/Velvet BSDF Shader node\nAdds sheen/velvet reflection to materials, such as cloth\nTypically mixed with other shaders (such as a Diffuse Shader) and is not particularly useful on its own");
  define("ShaderNode", "ShaderNodeBsdfToon", def_toon, ICON_NODE_TOONSHADER, "Add a Toon BSDF Shader node\nCreate Diffuse and Glossy materials with cartoon light effects");
  define("ShaderNode", "ShaderNodeBsdfTranslucent", nullptr, ICON_NODE_TRANSLUCENT, "Add a Translucent BSDF Shader node\nAdds Lambertian diffuse transmission");
  define("ShaderNode", "ShaderNodeBsdfTransparent", nullptr, ICON_NODE_TRANSPARENT, "Add a Transparent BSDF Shader node\nAdds transparency without refraction");
  define("ShaderNode", "ShaderNodeBump", def_sh_bump, ICON_NODE_BUMP, "Add a Bump Shader node\nGenerates a perturbed normal from a height texture, for bump mapping");
  define("ShaderNode", "ShaderNodeCameraData", nullptr, ICON_CAMERA_DATA, "Add a Camera Data Shader node\nGet information about the position of the object relative to the camera");
  define("ShaderNode", "ShaderNodeClamp", def_clamp, ICON_NODE_CLAMP, "Add a Clamp Shader node\nClamps a value between a minimum and a maximum");
  define("ShaderNode", "ShaderNodeCombineColor", def_sh_combsep_color, ICON_COMBINE_COLOR, "Add a Combine Color Shader node\nCombines single colors to a rgb, hsv or hsl color value");
  define("ShaderNode", "ShaderNodeCombineHSV", nullptr, ICON_NODE_COMBINEHSV, "Add a Combine HSV Shader node\nCombine the single HSV channels into a single image");
  define("ShaderNode", "ShaderNodeCombineRGB", nullptr, ICON_NODE_COMBINERGB, "Add a Combine RGB Shader node\nCombine the single RGB channels into a single image (Deprecated)");
  define("ShaderNode", "ShaderNodeCombineXYZ", nullptr, ICON_NODE_COMBINEXYZ, "Add a Combine XYZ Shader node\nCombine the single RGB channels into a single image by values between 0 and 1");
  define("ShaderNode", "ShaderNodeDisplacement", def_sh_displacement, ICON_MOD_DISPLACE, "Add a Displacement Shader node\nDisplace the surface along all the surface normal");
  define("ShaderNode", "ShaderNodeEeveeSpecular", nullptr, ICON_NODE_GLOSSYSHADER, "Add a Specular BSDF Shader node\nCombines multiple shader layers in a single node");
  define("ShaderNode", "ShaderNodeEmission", nullptr, ICON_NODE_EMISSION, "Add a Emission Shader node\nThe Emission node emits light");
  define("ShaderNode", "ShaderNodeFloatCurve", def_float_curve, ICON_FLOAT_CURVE, "Add a Curve Float Shader node\nMaps an input float to a curve and outputs a float value");
  define("ShaderNode", "ShaderNodeFresnel", nullptr, ICON_NODE_FRESNEL, "Add a Fresnel Shader node\nAdds Fresnel effect. The more a face goes towards 180 degrees, the more it is reflecting");
  define("ShaderNode", "ShaderNodeGamma", nullptr, ICON_NODE_GAMMA, "Add a Gamma Shader node\nApply a gamma correction");
  define("ShaderNode", "ShaderNodeHairInfo", nullptr, ICON_NODE_HAIRINFO, "Add a Curves Info Shader node\nGives access to Hair information");
  define("ShaderNode", "ShaderNodeHoldout", nullptr, ICON_NODE_HOLDOUTSHADER, "Add a Holdout Shader node\nCreate a “hole” in the image with zero alpha transparency");
  define("ShaderNode", "ShaderNodeHueSaturation", nullptr, ICON_NODE_HUESATURATION, "Add a Hue/Saturation/Value Shader node\nColor transformation in the HSV color space");
  define("ShaderNode", "ShaderNodeInvert", nullptr, ICON_NODE_INVERT, "Add an Invert Color Shader node\nInverts the colors in the input image, producing a negative");
  define("ShaderNode", "ShaderNodeLayerWeight", nullptr, ICON_NODE_LAYERWEIGHT, "Add a Layer Weight Shader node\nOutputs a weight. Typically used for layering shaders with the Mix Shader node");
  define("ShaderNode", "ShaderNodeLightFalloff", nullptr, ICON_NODE_LIGHTFALLOFF, "Add a Light Falloff Shader node\nAllows you to manipulate how light intensity decreases over distance");
  define("ShaderNode", "ShaderNodeLightPath", nullptr, ICON_NODE_LIGHTPATH, "Add a Light Path Shader node\nRetreives for which kind of incoming ray the shader is being executed");
  define("ShaderNode", "ShaderNodeMapping", def_sh_mapping, ICON_NODE_MAPPING, "Add a Mapping Shader node\nTransform the input vector by applying translation, rotation, and scale");
  define("ShaderNode", "ShaderNodeMapRange", def_map_range, ICON_NODE_MAP_RANGE, "Add a Map Range Shader node\nRemaps a value from a source range to a target range");
  define("ShaderNode", "ShaderNodeMath", def_math, ICON_NODE_MATH, "Add a Math Shader node\nPerforms math operations");
  define("ShaderNode", "ShaderNodeMix", def_sh_mix, ICON_NODE_MIX, "Add a Mix Shader node\nMixes values by a factor");
  define("ShaderNode", "ShaderNodeMixRGB", def_mix_rgb, ICON_NODE_MIXRGB, "Add a Mix RGB Shader node\nMixes images by working on the individual and corresponding pixels of the two input images");
  define("ShaderNode", "ShaderNodeMixShader", nullptr, ICON_NODE_MIXSHADER, "Add a Mix Shader Shader node\nMix two shaders together by a factor");
  define("ShaderNode", "ShaderNodeNewGeometry", nullptr, ICON_NODE_GEOMETRY, "Add a Geometry Shader node\nGives geometric information about the current shading point");
  define("ShaderNode", "ShaderNodeNormal", nullptr, ICON_RECALC_NORMALS, "Add a Normal Shader node\nGenerate a normal vector and a dot product");
  define("ShaderNode", "ShaderNodeNormalMap", def_sh_normal_map, ICON_NODE_NORMALMAP, "Add a Normal Map Shader node\nGenerates a perturbed normal from an RGB normal map image");
  define("ShaderNode", "ShaderNodeObjectInfo", nullptr, ICON_NODE_OBJECTINFO, "Add a Object Info Shader node\nRetreives information about the object instance");
  define("ShaderNode", "ShaderNodeOutputAOV", def_sh_output_aov, ICON_NODE_VALUE, "Add a AOV Output Shader node\nProvides custom render passes for arbitrary shader node components\nNote that the AOV Node is NOT compatible with Cycles in the realtime compositor!");
  define("ShaderNode", "ShaderNodeOutputLight", def_sh_output, ICON_LIGHT, "Add a Light Output Shader node\nOutputs light information to a light object");
  define("ShaderNode", "ShaderNodeOutputLineStyle", def_sh_output_linestyle, ICON_NODE_LINESTYLE_OUTPUT, "Add a Line Style Output Shader node\nA Line Style shader");
  define("ShaderNode", "ShaderNodeOutputMaterial", def_sh_output, ICON_MATERIAL, "Add a Material Output Shader node\nOutput surface material information to a surface object");
  define("ShaderNode", "ShaderNodeOutputWorld", def_sh_output, ICON_WORLD, "Add a World Output Shader node\nOutputs light and color information to the scene’s World");
  define("ShaderNode", "ShaderNodeParticleInfo", nullptr, ICON_NODE_PARTICLEINFO, "Add a Particle Info Shader node\nGet access to the data of the particle that spawned the object instance");
  define("ShaderNode", "ShaderNodePointInfo", nullptr, ICON_POINT_INFO, "Add a Point Info Shader node\nRetreive info from a point cloud");
  define("ShaderNode", "ShaderNodeRGB", nullptr, ICON_NODE_RGB, "Add a RGB Shader node\nSet a color with a color picker");
  define("ShaderNode", "ShaderNodeRGBCurve", def_rgb_curve, ICON_NODE_RGBCURVE, "Add a RGB Curves Shader node\nApply color corrections for each color channel and levels adjustments in the compositing context");
  define("ShaderNode", "ShaderNodeRGBToBW", nullptr, ICON_NODE_RGBTOBW, "Add a RGB to BW Shader node\nConverts an RGB color image to a gray-scale image based at its luminance");
  define("ShaderNode", "ShaderNodeScript", def_sh_script, ICON_FILE_SCRIPT, "Add a Script Shader node\nIn this node you can load OSL shaders.\nNote: OSL shaders are not supported on all GPU backends");
  define("ShaderNode", "ShaderNodeSeparateColor", def_sh_combsep_color, ICON_SEPARATE_COLOR, "Add a Separate Color Shader node\nSeparates the values of a rgb, hsv or hsl color into its single values");
  define("ShaderNode", "ShaderNodeSeparateHSV", nullptr, ICON_NODE_SEPARATEHSV, "Add a Separate HSV Shader node\nSeparates the single HSV channels from a single image");
  define("ShaderNode", "ShaderNodeSeparateRGB", nullptr, ICON_NODE_SEPARATERGB, "Add a Separate RGB Shader node\nSeparates the single RGB channels from a single image (Deprecated)");
  define("ShaderNode", "ShaderNodeSeparateXYZ", nullptr, ICON_NODE_SEPARATEXYZ, "Add a Separate XYZ Shader node\nSeparates the single RGB channels from a single image by values between 0 and 1");
  define("ShaderNode", "ShaderNodeShaderToRGB", nullptr, ICON_NODE_RGB, "Add a Shader to RGB Shader node\nConvert PBR rendering effect (such as light and shadow) to RGBA color. Typically used for non-photorealistic rendering to apply additional effects on the output of BSDFs.\nNote: only supported for Eevee\n Warning, this may break the PBR workflow");
  define("ShaderNode", "ShaderNodeSqueeze", nullptr, ICON_NONE, "Add a Squeeze Value Shader node\nScale down high values of the camera data node");
  define("ShaderNode", "ShaderNodeSubsurfaceScattering", def_sh_subsurface, ICON_NODE_SSS, "Add a Subsurface Scattering Shader node\nSimple subsurface multiple scattering, for skin, wax, etc");
  define("ShaderNode", "ShaderNodeTangent", def_sh_tangent, ICON_NODE_TANGENT, "Add a Tangent Shader node\nGenerates a tangent direction for the Anisotropic BSDF");
  define("ShaderNode", "ShaderNodeTexBrick", def_sh_tex_brick, ICON_NODE_BRICK, "Add a Brick Texture Shader node\nAdds a procedural brick texture");
  define("ShaderNode", "ShaderNodeTexChecker", def_sh_tex_checker, ICON_NODE_CHECKER, "Add a Checker Texture Shader node\nAdds a procedural checkerboard texture");
  define("ShaderNode", "ShaderNodeTexCoord", def_sh_tex_coord, ICON_NODE_TEXCOORDINATE, "Add a Texture Coordinate Shader node\nDefine some texture coordinate types");
  define("ShaderNode", "ShaderNodeTexEnvironment", def_sh_tex_environment, ICON_NODE_ENVIRONMENT, "Add a Environment Texture Shader node\nLoad an environment texture to light your scene");
  define("ShaderNode", "ShaderNodeTexGabor", def_sh_tex_gabor, ICON_GABOR_NOISE, "Add a Gabor Texture Node\nGenerate Gabor texture noise");
  define("ShaderNode", "ShaderNodeTexGradient", def_sh_tex_gradient, ICON_NODE_GRADIENT, "Add a Gradient Texture Shader node\nGenerates interpolated color and intensity values based on the input vector");
  define("ShaderNode", "ShaderNodeTexIES", def_sh_tex_ies, ICON_LIGHT, "Add a IES Texture Shader node\nMatch real world lights based on IES files");
  define("ShaderNode", "ShaderNodeTexImage", def_sh_tex_image, ICON_FILE_IMAGE, "Add an Image Texture Shader node\nAdd an image file as a texture");
  define("ShaderNode", "ShaderNodeTexMagic", def_sh_tex_magic, ICON_MAGIC_TEX, "Add a Magic Texture Shader node\nAdds a procedural psychedelic color texture");
  define("ShaderNode", "ShaderNodeTexNoise", def_sh_tex_noise, ICON_NOISE_TEX, "Add a Noise Texture Shader node\nEvaluates a fractal Perlin noise at the input texture coordinates");
  define("ShaderNode", "ShaderNodeTexPointDensity", def_sh_tex_pointdensity, ICON_NODE_POINTCLOUD, "Add a Point Density Shader node\nAdds volumetric points for each particle or vertex of another object");
  define("ShaderNode", "ShaderNodeTexSky", def_sh_tex_sky, ICON_NODE_SKY, "Add a Sky Texture Shader node\nAdds a procedural Sky texture");
  define("ShaderNode", "ShaderNodeTexVoronoi", def_sh_tex_voronoi, ICON_VORONI_TEX, "Add a Voronoi Texture Shader node\nEvaluates a Worley Noise at the input texture coordinates");
  define("ShaderNode", "ShaderNodeTexWave", def_sh_tex_wave, ICON_NODE_WAVES, "Add a Wave Texture Shader node\nAdds procedural bands or rings with noise distortion");
  define("ShaderNode", "ShaderNodeTexWhiteNoise", def_sh_tex_white_noise, ICON_NODE_WHITE_NOISE, "Add a White Noise Texture Shader node\nAdds white noise");
  define("ShaderNode", "ShaderNodeUVAlongStroke", def_sh_uvalongstroke, ICON_NODE_UVALONGSTROKE, "Add a UV Along Stroke Shader node\nMaps textures along the stroke length");
  define("ShaderNode", "ShaderNodeUVMap", def_sh_uvmap, ICON_GROUP_UVS, "Add a UV Map Shader node\nRetrieve specific UV maps");
  define("ShaderNode", "ShaderNodeValToRGB", def_colorramp, ICON_NODE_COLORRAMP, "Add a Color Ramp Shader node\nMap values to colors with the use of a gradient");
  define("ShaderNode", "ShaderNodeValue", nullptr, ICON_NODE_VALUE, "Add a Value Shader node\nUsed to Input numerical values to other nodes in the tree");
  define("ShaderNode", "ShaderNodeVectorCurve", def_vector_curve, ICON_NODE_VECTOR, "Add a Vector Curves node\nMap input vector components with curves");
  define("ShaderNode", "ShaderNodeVectorDisplacement", def_sh_vector_displacement, ICON_VECTOR_DISPLACE, "Add a Vector Displacement Shader node\nDisplace the surface along arbitrary directions");
  define("ShaderNode", "ShaderNodeVectorMath", def_vector_math, ICON_NODE_VECTORMATH, "Add a Vector Math Shader node\nPerforms a selected math operation on the input vectors");
  define("ShaderNode", "ShaderNodeVectorRotate", def_sh_vector_rotate, ICON_NODE_VECTORROTATE, "Add a Vector Rotate Shader node\nRotate a vector around a center point");
  define("ShaderNode", "ShaderNodeVectorTransform", def_sh_vect_transform, ICON_NODE_VECTOR_TRANSFORM, "Add a Vector Transform Shader node\nConvert a vector, point, or normal between world and camera and object coordinate space");
  define("ShaderNode", "ShaderNodeVertexColor", def_sh_vertex_color, ICON_NODE_VERTEX_COLOR, "Add a Color Attribute Shader node\nProvides vertex colors as well as their alpha value");
  define("ShaderNode", "ShaderNodeVolumeAbsorption", nullptr, ICON_NODE_VOLUMEABSORPTION, "Add a Volume Absorption Shader node\nAllows light to be absorbed as it passes through the volume");
  define("ShaderNode", "ShaderNodeVolumeInfo", nullptr, ICON_NODE_VOLUME_INFO, "Add a Volume Info Shader node\nRetreives information about Smoke Domains");
  define("ShaderNode", "ShaderNodeVolumePrincipled", nullptr, ICON_NODE_VOLUMEPRINCIPLED, "Add a Principled Volume Shader node\nAll volume shading components in a single node");
  define("ShaderNode", "ShaderNodeVolumeScatter", def_scatter, ICON_NODE_VOLUMESCATTER, "Add a Volume Scatter Shader node\nAllows light to be scattered as it passes through the volume");
  define("ShaderNode", "ShaderNodeWavelength", nullptr, ICON_NODE_WAVELENGTH, "Add a Wavelength Shader node\nConverts a wavelength value to an RGB value");
  define("ShaderNode", "ShaderNodeWireframe", def_sh_tex_wireframe, ICON_NODE_WIREFRAME, "Add a Wireframe Shader node\nRetreive and render the wireframe, triangulated");

  define("CompositorNode", "CompositorNodeAlphaOver", def_cmp_alpha_over, ICON_IMAGE_ALPHA, "Add a Alpha Over Compositor node\nLayer images with an alpha channel on top of one another");
  define("CompositorNode", "CompositorNodeAntiAliasing", def_cmp_antialiasing, ICON_ANTIALIASED, "Add a Anti-Aliasing Compositor node\nAnti-alias an image");
  define("CompositorNode", "CompositorNodeBilateralblur", def_cmp_bilateral_blur, ICON_NODE_BILATERAL_BLUR, "Add a Bilateral Blur Compositor node\nPerforms a high-quality adaptive blur on the source image");
  define("CompositorNode", "CompositorNodeBlur", def_cmp_blur, ICON_NODE_BLUR, "Add a Blur Compositor node\nBlur an image");
  define("CompositorNode", "CompositorNodeBokehBlur", def_cmp_bokehblur, ICON_NODE_BOKEH_BLUR, "Add a Bokeh Blur Compositor node\nGenerates a bokeh type blur");
  define("CompositorNode", "CompositorNodeBokehImage", def_cmp_bokehimage, ICON_NODE_BOKEH_IMAGE, "Add a Bokeh Image Compositor node\nGenerates a special input image for use with the Bokeh Blur filter node");
  define("CompositorNode", "CompositorNodeBoxMask", def_cmp_boxmask, ICON_NODE_BOXMASK, "Add a Box Mask Compositor node\nCreates an image suitable for use as a simple matte");
  define("CompositorNode", "CompositorNodeBrightContrast", def_cmp_brightcontrast, ICON_BRIGHTNESS_CONTRAST, "Add a Brightness/Contrast Compositor node\nAdjust the brightness and contrast");
  define("CompositorNode", "CompositorNodeChannelMatte", def_cmp_channel_matte, ICON_NODE_CHANNEL, "Add a Channel Key Compositor node\nDetermines background objects from foreground objects by the difference in the selected channel’s levels");
  define("CompositorNode", "CompositorNodeChromaMatte", def_cmp_chroma_matte, ICON_NODE_CHROMA, "Add a Chroma Key Compositor node\nDetermines if a pixel is a foreground or background (and thereby should be transparent) based on its chroma values");
  define("CompositorNode", "CompositorNodeColorBalance", def_cmp_colorbalance, ICON_NODE_COLORBALANCE, "Add a Color Balance Compositor node\nAdjust the color and values of an image");
  define("CompositorNode", "CompositorNodeColorCorrection", def_cmp_colorcorrection, ICON_NODE_COLORCORRECTION, "Add a Color Correction Compositor node\nAdjust the color of an image");
  define("CompositorNode", "CompositorNodeColorMatte", def_cmp_color_matte, ICON_COLOR, "Add a Color Key Compositor node\nCreates a matte based on a specified color of the input image");
  define("CompositorNode", "CompositorNodeColorSpill", def_cmp_color_spill, ICON_NODE_SPILL, "Add a Color Spill Compositor node\nReduces one of the RGB channels so that it is not greater than any of the others");
  define("CompositorNode", "CompositorNodeCombHSVA", nullptr, ICON_NODE_COMBINEHSV, "Add a Combine HSVA Compositor node\nCombine the single HSV channels into a single image");
  define("CompositorNode", "CompositorNodeCombineColor", def_cmp_combsep_color, ICON_COMBINE_COLOR, "Add a Separate Color Compositor node\nSeparates the values of a rgb, hsv or hsl color into its single values");
  define("CompositorNode", "CompositorNodeCombineXYZ", nullptr, ICON_NODE_COMBINEXYZ, "Add a Combine XYZ Compositor Node\nCombine the single RGB channels into a single image by values between 0 and 1");
  define("CompositorNode", "CompositorNodeCombRGBA", nullptr, ICON_NODE_COMBINERGB, "Add a Combine RGBA Compositor node\nCombine the single RGB channels into a single image");
  define("CompositorNode", "CompositorNodeCombYCCA", def_cmp_ycc, ICON_NODE_COMBINEYCBCRA, "Add a Combine YCbCrA Compositor node\nConverts an YCbCrA image to RGBA color space and unions the channels");
  define("CompositorNode", "CompositorNodeCombYUVA", nullptr, ICON_NODE_COMBINEYUVA, "Add a Combine YUVA Compositor node\nConverts an YUVA image to RGBA color space");
  define("CompositorNode", "CompositorNodeComposite", def_cmp_composite, ICON_NODE_COMPOSITING, "Add a Composite Compositor node\nComposite output to the renderer");
  define("CompositorNode", "CompositorNodeConvertColorSpace", def_cmp_convert_color_space, ICON_COLOR_SPACE, "Add a Color Space Node\nConvert the color space from one color space to another");
  define("CompositorNode", "CompositorNodeCornerPin", nullptr, ICON_NODE_CORNERPIN, "Add a Corner Pin Compositor node\nUses explicit corner values for a plane warp transformation");
  define("CompositorNode", "CompositorNodeCrop", def_cmp_crop, ICON_NODE_CROP, "Add a Crop Compositor node\nCrops an image to a selected region");
  define("CompositorNode", "CompositorNodeCryptomatte", def_cmp_cryptomatte_legacy, ICON_CRYPTOMATTE, "Add a Cryptomatte (Legacy) Compositor node\ncreate mattes for compositing. Deprecated method");
  define("CompositorNode", "CompositorNodeCryptomatteV2", def_cmp_cryptomatte, ICON_CRYPTOMATTE, "Add a Cryptomatte Compositor node\nCreate mattes for compositing");
  define("CompositorNode", "CompositorNodeCurveRGB", def_rgb_curve, ICON_NODE_RGBCURVE, "Add a RGB Curves Compositor node\nAllows color corrections for each color channel and levels adjustments");
  define("CompositorNode", "CompositorNodeCurveVec", def_vector_curve, ICON_NODE_VECTOR, "Add a Vector Curves Compositor node\nMaps an input vector components to a curve");
  define("CompositorNode", "CompositorNodeDBlur", def_cmp_dblur, ICON_NODE_DIRECITONALBLUR, "Add a Directional Blur Compositor node\nBlurs an image in a specified direction and magnitude");
  define("CompositorNode", "CompositorNodeDefocus", def_cmp_defocus, ICON_NODE_DEFOCUS, "Add a Defocus Compositor node\nEmulates depth of field (DOF)");
  define("CompositorNode", "CompositorNodeDenoise", def_cmp_denoise, ICON_NODE_DENOISE, "Add a Denoise Compositor node\nDenoises the image");
  define("CompositorNode", "CompositorNodeDespeckle", def_cmp_despeckle, ICON_NODE_DESPECKLE, "Add a Despeckle Compositor node\nSmooth areas of an image in which noise is noticeable");
  define("CompositorNode", "CompositorNodeDiffMatte", def_cmp_diff_matte, ICON_SELECT_DIFFERENCE, "Add a Difference Key Compositor node\nProduces a matte that isolates foreground content by comparing it with a reference background image");
  define("CompositorNode", "CompositorNodeDilateErode", def_cmp_dilate_erode, ICON_NODE_ERODE, "Add a Dilate/Erode Compositor node\nProvides a morphology filter to dilate or erode the image");
  define("CompositorNode", "CompositorNodeDisplace", nullptr, ICON_MOD_DISPLACE, "Add a Displace Compositor node\nDisplaces the pixel position based on an input vector");
  define("CompositorNode", "CompositorNodeDistanceMatte", def_cmp_distance_matte, ICON_DRIVER_DISTANCE, "Add a Distance Key Compositor node\nDetermines a pixel’s alpha value");
  define("CompositorNode", "CompositorNodeDoubleEdgeMask", def_cmp_double_edge_mask, ICON_NODE_DOUBLEEDGEMASK, "Add a Double Edge Mask Compositor node\nCreates a gradient between two masks");
  define("CompositorNode", "CompositorNodeEllipseMask", def_cmp_ellipsemask, ICON_NODE_ELLIPSEMASK, "Add a Ellipse Mask Compositor node\ncreates an image suitable for use as a simple matte or vignette mask");
  define("CompositorNode", "CompositorNodeExposure", nullptr, ICON_EXPOSURE, "Add a Exposure Compositor node\nMake areas of an image brighter or dimmer");
  define("CompositorNode", "CompositorNodeFilter", def_cmp_filter, ICON_FILTER, "Add a Filter Compositor node\nProvides various common image enhancement filters");
  define("CompositorNode", "CompositorNodeFlip", def_cmp_flip, ICON_FLIP, "Add a Flip Compositor node\nFlips an image at defined axis");
  define("CompositorNode", "CompositorNodeGamma", nullptr, ICON_NODE_GAMMA, "Add a Gamma Compositor node\nApply a gamma correction");
  define("CompositorNode", "CompositorNodeGlare", def_cmp_glare, ICON_NODE_GLARE, "Add a Glare Compositor node\nAdds lens flares, fog, glows around exposed parts of an image");
  define("CompositorNode", "CompositorNodeHueCorrect", def_cmp_huecorrect, ICON_NODE_HUESATURATION, "Add a Hue Correct Compositor node\nAdjust the Hue, Saturation, and Value of an image with an input curve");
  define("CompositorNode", "CompositorNodeHueSat", nullptr, ICON_NODE_HUESATURATION, "Add a Hue/Saturation/Value Compositor node\nApply a color transformation in the HSV color space");
  define("CompositorNode", "CompositorNodeIDMask", def_cmp_id_mask, ICON_MOD_MASK, "Add a ID Mask Compositor node\nAccess an alpha mask per object or per material");
  define("CompositorNode", "CompositorNodeImage", def_cmp_image, ICON_FILE_IMAGE, "Add an Image Compositor node\nImage input");
  define("CompositorNode", "CompositorNodeInpaint", def_cmp_inpaint, ICON_NODE_IMPAINT, "Add a Inpaint Compositor node\nExtend borders of an image into transparent or masked regions");
  define("CompositorNode", "CompositorNodeInvert", def_cmp_invert, ICON_NODE_INVERT, "Add an Invert Color Compositor node\nInverts the colors in the input image, producing a negative");
  define("CompositorNode", "CompositorNodeKeying", def_cmp_keying, ICON_NODE_KEYING, "Add a Keying Compositor node\nPerforms chroma keying to remove the backdrop and despill to correct color cast from the backdrop");
  define("CompositorNode", "CompositorNodeKeyingScreen", def_cmp_keyingscreen, ICON_NODE_KEYINGSCREEN, "Add a Keying Screen Compositor node\nCreates plates for use as a color reference for keying nodes");
  define("CompositorNode", "CompositorNodeKuwahara", def_cmp_kuwahara, ICON_KUWAHARA, "Add a Kuwahara Compositor node\nKuwahara is a stylize filter");
  define("CompositorNode", "CompositorNodeLensdist", def_cmp_lensdist, ICON_NODE_LENSDISTORT, "Add a Lens Distortion Compositor node\nSimulate distortions from real camera lenses");
  define("CompositorNode", "CompositorNodeLevels", def_cmp_levels, ICON_LEVELS, "Add a Levels Compositor node\nReads the inputs color channels and outputs analytical values");
  define("CompositorNode", "CompositorNodeLumaMatte", def_cmp_luma_matte, ICON_NODE_LUMINANCE, "Add a Luminance Key Compositor node\nDetermines background objects from foreground objects by the difference in the brightness level");
  define("CompositorNode", "CompositorNodeMapRange", def_cmp_map_range, ICON_NODE_MAP_RANGE, "Add a Map Range Compositor node\nRemaps a value from a source range to a target range");
  define("CompositorNode", "CompositorNodeMapUV", def_cmp_map_uv, ICON_GROUP_UVS, "Add a Map UV Compositor node\nAllows to re-texture objects after they have been rendered");
  define("CompositorNode", "CompositorNodeMapValue", def_cmp_map_value, ICON_NODE_VALUE, "Add a Map Value Compositor node\nScale, offset and clamp values");
  define("CompositorNode", "CompositorNodeMask", def_cmp_mask, ICON_MOD_MASK, "Add a Mask Compositor node\nThe Mask node can be used to select a Mask data");
  define("CompositorNode", "CompositorNodeMath", def_math, ICON_NODE_MATH, "Add a Math Compositor node\nPerforms math operations");
  define("CompositorNode", "CompositorNodeMixRGB", def_mix_rgb, ICON_NODE_MIXRGB, "Add a Mix Compositor node\nMixes images by working on the individual and corresponding pixels of the two input images");
  define("CompositorNode", "CompositorNodeMovieClip", def_cmp_movieclip, ICON_FILE_MOVIE, "Add a Movie Clip Compositor node\nTakes values from footage cameras and trackings, and links them to the output");
  define("CompositorNode", "CompositorNodeMovieDistortion", def_cmp_moviedistortion, ICON_NODE_MOVIEDISTORT, "Add a Movie Distortion Compositor node\nAdds distortion to render or removes distortion from movies to make them fit together ");
  define("CompositorNode", "CompositorNodeNormal", nullptr, ICON_RECALC_NORMALS, "Add a Normal Compositor node\nGenerates a normal vector and a dot product");
  define("CompositorNode", "CompositorNodeNormalize", nullptr, ICON_NODE_NORMALIZE, "Add a Normalize Compositor node\nFind the minimum and maximum values of a single channel in the range of 0 and 1. ");
  define("CompositorNode", "CompositorNodeOutputFile", def_cmp_output_file, ICON_NODE_FILEOUTPUT, "Add a File Output Compositor node\nWrites out an image as part of a frame set sequence");
  define("CompositorNode", "CompositorNodePixelate", def_cmp_pixelate, ICON_NODE_PIXELATED, "Add a Pixelate Compositor node\nAdd this node in front of a Scale node to get a pixelated (non-smoothed) image");
  define("CompositorNode", "CompositorNodePlaneTrackDeform", def_cmp_planetrackdeform, ICON_NODE_PLANETRACKDEFORM, "Add a Plan track Deform node\nReplace flat planes in footage by another image, detected by plane tracks from motion tracking");
  define("CompositorNode", "CompositorNodePosterize", nullptr, ICON_POSTERIZE, "Add a Posterize Node\nPosterize reduces the number of colors");
  define("CompositorNode", "CompositorNodePremulKey", def_cmp_premul_key, ICON_NODE_ALPHACONVERT, "Add a Alpha Convert Compositor node\nConverts the alpha channel interpretation of an image from pre-multiplied to straight or vice versa");
  define("CompositorNode", "CompositorNodeRGB", nullptr, ICON_NODE_RGB, "Add a RGB Compositor node\nSets a color");
  define("CompositorNode", "CompositorNodeRGBToBW", nullptr, ICON_NODE_RGBTOBW, "Add a RGB to BW Compositor node\nConverts an RGB color image to a gray-scale image based at its luminance");
  define("CompositorNode", "CompositorNodeRLayers", def_cmp_render_layers, ICON_RENDERLAYERS, "Add a Render Layers Compositor node\nInputs the available render layers");
  define("CompositorNode", "CompositorNodeRotate", def_cmp_rotate, ICON_TRANSFORM_ROTATE, "Add a Rotate Compositor node\nRotate a texture");
  define("CompositorNode", "CompositorNodeScale", def_cmp_scale, ICON_TRANSFORM_SCALE, "Add a Scale Compositor node\nScale a texture");
  define("CompositorNode", "CompositorNodeSceneTime", nullptr, ICON_TIME, "Add a Scene Time Node\nOutputs the current scene time in seconds or in frames");
  define("CompositorNode", "CompositorNodeSeparateColor", def_cmp_combsep_color, ICON_SEPARATE_COLOR, "Add a Combine Color Compositor node\nCombines single colors to a rgb, hsv or hsl color value");
  define("CompositorNode", "CompositorNodeSeparateXYZ", nullptr, ICON_NODE_SEPARATEXYZ, "Add a Separate XYZ Compositor Node\nSeparates the single RGB channels from a single image by values between 0 and 1");
  define("CompositorNode", "CompositorNodeSepHSVA", nullptr, ICON_NODE_SEPARATEHSV, "Add a Separate HSVA Compositor node\nSeparates the single RGB channels from a single image");
  define("CompositorNode", "CompositorNodeSepRGBA", nullptr, ICON_NODE_SEPARATERGB, "Add a Separate RGBA Compositor node\nSeparates the RGBA values from a single image");
  define("CompositorNode", "CompositorNodeSepYCCA", def_cmp_ycc, ICON_NODE_SEPARATE_YCBCRA, "Add a Separate YCbCrA Compositor node\nConverts an RGBA image to YCbCrA color space, and splits it to single output");
  define("CompositorNode", "CompositorNodeSepYUVA", nullptr, ICON_NODE_SEPARATE_YUVA, "Add a Separate YUVA Compositor node\nConverts an RGBA image to YUVA color space");
  define("CompositorNode", "CompositorNodeSetAlpha", def_cmp_set_alpha, ICON_IMAGE_ALPHA, "Add a Set Alpha Compositor node\nAdds an alpha channel to an image");
  define("CompositorNode", "CompositorNodeSplit", def_cmp_split, ICON_NODE_VIWERSPLIT, "Add a Split Compositor node\ndisplays two images side-by-side as backdrop, or as a Viewer Node output");
  define("CompositorNode", "CompositorNodeStabilize", def_cmp_stabilize2d, ICON_NODE_STABILIZE2D, "Add a Stabilize 2D Compositor node\nStabilizes the footage according to the settings set in Movie Clip Editor");
  define("CompositorNode", "CompositorNodeSunBeams", def_cmp_sunbeams, ICON_NODE_SUNBEAMS, "Add a Sun Beams Compositor node\nCreates 2D sun beams");
  define("CompositorNode", "CompositorNodeSwitch", def_cmp_switch, ICON_SWITCH_DIRECTION, "Add a Switch Compositor node\nSwitch between two images");
  define("CompositorNode", "CompositorNodeSwitchView", def_cmp_switch_view, ICON_VIEW_SWITCHACTIVECAM, "Add a Switch View Compositor node\nCombines the views (left and right) into a single Stereo 3D output");
  define("CompositorNode", "CompositorNodeTexture", def_texture, ICON_TEXTURE, "Add a Texture Compositor node\nAllows you to use 3D textures in the Compositor");
  define("CompositorNode", "CompositorNodeTime", def_time, ICON_NODE_CURVE_TIME, "Add a Time Curve Compositor node\ngenerates a factor value that changes according to the curve as time progresses through the Timeline");
  define("CompositorNode", "CompositorNodeTonemap", def_cmp_tonemap, ICON_NODE_TONEMAP, "Add a Tonemap Compositor node\nAllows Tonemapping");
  define("CompositorNode", "CompositorNodeTrackPos", def_cmp_trackpos, ICON_NODE_TRACKPOSITION, "Add a Track Position Compositor node\nreturn information about a tracking marker to the Compositor\nYou need a tracking project");
  define("CompositorNode", "CompositorNodeTransform", dev_cmd_transform, ICON_NODE_TRANSFORM, "Add a Transform Compositor node\nMove, rotate or scale an image");
  define("CompositorNode", "CompositorNodeTranslate", def_cmp_translate, ICON_TRANSFORM_MOVE, "Add a Translate Compositor node\nMove an image");
  define("CompositorNode", "CompositorNodeValToRGB", def_colorramp, ICON_NODE_COLORRAMP, "Add a Color Ramp Compositor node\nMap color values by gradient");
  define("CompositorNode", "CompositorNodeValue", nullptr, ICON_NODE_VALUE, "Add a Value Compositor node\nInput numerical values to other nodes");
  define("CompositorNode", "CompositorNodeVecBlur", def_cmp_vector_blur, ICON_NODE_VECTOR_BLUR, "Add a Vector Blur Compositor node\nUses the vector speed render pass to blur the image pixels in 2D");
  define("CompositorNode", "CompositorNodeViewer", def_cmp_viewer, ICON_NODE_VIEWER, "Add a Viewer Compositor node\nDisplays the output as a backdrop in the viewport or in the Image editor");
  define("CompositorNode", "CompositorNodeZcombine", def_cmp_zcombine, ICON_NODE_ZCOMBINE, "Add a Z Combine Compositor node\nCombines two images based on their Z-depth maps");

  define("TextureNode", "TextureNodeAt", nullptr, ICON_NONE, "Add a At Texture node\nReturns the color of a texture at the specified coordinates");
  define("TextureNode", "TextureNodeBricks", def_tex_bricks, ICON_NONE, "Add a Brick Texture node\nAdds a procedural brick texture");
  define("TextureNode", "TextureNodeChecker", nullptr, ICON_NONE, "Add a Checker Texture node\nAdds a procedural checkerboard texture");
  define("TextureNode", "TextureNodeCombineColor", def_tex_combsep_color, ICON_NONE, "Add a Combine Color Texture node\nCombines single colors to a rgb, hsv or hsl color value");
  define("TextureNode", "TextureNodeCompose", nullptr, ICON_NONE, "Add a Combine RGBA Texture node\nCombine the single RGB channels into a single imag");
  define("TextureNode", "TextureNodeCoordinates", nullptr, ICON_NONE, "Add a Coordinates Texture node\nOutputs the geometry local coordinates, relative to its bounding box as RGB colors");
  define("TextureNode", "TextureNodeCurveRGB", def_rgb_curve, ICON_NONE, "Add a RGB Curves Texture node\nAllows color corrections for each color channel and levels adjustments");
  define("TextureNode", "TextureNodeCurveTime", def_time, ICON_NONE, "Add a Curve Time Texture node\nAdjust the changes over time by curves");
  define("TextureNode", "TextureNodeDecompose", nullptr, ICON_NONE, "Add a Separate RGBA Texture node\nSeparates the single RGBA channels from a single image");
  define("TextureNode", "TextureNodeDistance", nullptr, ICON_NONE, "Add a Distance Texture node\nComputes the distance between two 3D coordinates");
  define("TextureNode", "TextureNodeHueSaturation", nullptr, ICON_NONE, "Add a Hue/Saturation/Value Texture node\nColor transformation in the HSV color space");
  define("TextureNode", "TextureNodeImage", def_tex_image, ICON_NONE, "Add an Image Texture node\nAdd an image file as a texture");
  define("TextureNode", "TextureNodeInvert", nullptr, ICON_NONE, "Add a Invert Texture node\nInverts the colors in the input image, producing a negative");
  define("TextureNode", "TextureNodeMath", def_math, ICON_NONE, "Add a Math Texture node\nPerforms math operations");
  define("TextureNode", "TextureNodeMixRGB", def_mix_rgb, ICON_NONE, "Add a Mix RGB Texture node\nMixes images by working on the individual and corresponding pixels of the two input images");
  define("TextureNode", "TextureNodeOutput", def_tex_output, ICON_NONE, "Add a Output Texture node\nOutput for node textures");
  define("TextureNode", "TextureNodeRGBToBW", nullptr, ICON_NONE, "Add a RGB to BW Texture node\nConverts an RGB color image to a gray-scale image based at its luminance");
  define("TextureNode", "TextureNodeRotate", nullptr, ICON_NONE, "Add a Rotate Texture node\nRotate an image");
  define("TextureNode", "TextureNodeScale", nullptr, ICON_NONE, "Add a Scale Texture node\nScales the size of an image");
  define("TextureNode", "TextureNodeSeparateColor", def_tex_combsep_color, ICON_NONE, "Add a Separate Color Texture node\nSeparates the values of a rgb, hsv or hsl color into its single values");
  define("TextureNode", "TextureNodeTexBlend", nullptr, ICON_NONE, "Add a Blend Texture node\nGenerates a smoothly interpolated progression");
  define("TextureNode", "TextureNodeTexClouds", nullptr, ICON_NONE, "Add a Clouds Texture node\nAdds Perlin noise");
  define("TextureNode", "TextureNodeTexDistNoise", nullptr, ICON_NONE, "Add a Distorted Noise Texture node\nGenerate distorted noise");
  define("TextureNode", "TextureNodeTexMagic", nullptr, ICON_NONE, "Add a Magic Texture node\nAdds a procedural psychedelic color texture");
  define("TextureNode", "TextureNodeTexMarble", nullptr, ICON_NONE, "Add a Marble Texture node\nGenerates marble, fire, or noise with a structure");
  define("TextureNode", "TextureNodeTexMusgrave", nullptr, ICON_NONE, "Add a Musgrave Texture node\nEvaluates a fractal Perlin noise at the input texture coordinates");
  define("TextureNode", "TextureNodeTexNoise", nullptr, ICON_NONE, "Add a Noise Texture node\nRandom generated noise");
  define("TextureNode", "TextureNodeTexStucci", nullptr, ICON_NONE, "Add a Stucci Texture node\nNoise based, but gives structures for stone, asphalt etc");
  define("TextureNode", "TextureNodeTexture", def_texture, ICON_NONE, "Add a Texture Texture node\nallows you to use 3D textures in the Compositor");
  define("TextureNode", "TextureNodeTexVoronoi", nullptr, ICON_NONE, "Add a Voronoi Texture node\nEvaluates a Worley Noise at the input texture coordinates");
  define("TextureNode", "TextureNodeTexWood", nullptr, ICON_NONE, "Add a Wood Texture node\nGenerate wood and ring-shaped patterns");
  define("TextureNode", "TextureNodeTranslate", nullptr, ICON_NONE, "Add a Translate Texture node\nMove the texture");
  define("TextureNode", "TextureNodeValToNor", nullptr, ICON_NONE, "Add a Value to Normal Texture node\nComputes a normal map");
  define("TextureNode", "TextureNodeValToRGB", def_colorramp, ICON_NONE, "Add a Color Ramp Texture node\nMaps values to colors with the use of a gradient");
  define("TextureNode", "TextureNodeViewer", nullptr, ICON_NONE, "Add a Viewer Texture node\nDisplays the output as a backdrop in the viewport or in the Image editor");

  define("FunctionNode", "FunctionNodeAlignEulerToVector", nullptr, ICON_ALIGN_EULER_TO_VECTOR, "Add a Align Euler to Vector Function node\nAligns a euler value to a vector");
  define("FunctionNode", "FunctionNodeAlignRotationToVector", nullptr, ICON_ALIGN_ROTATION_TO_VECTOR, "Add a Axes to Rotation Function node\nAligns a rotation to a vector");
  define("FunctionNode", "FunctionNodeAxesToRotation", nullptr, ICON_AXES_TO_ROTATION, "Add a Rotation to Vector Function node\nCreate a rotation from a primary and (ideally orthogonal) secondary axis");
  define("FunctionNode", "FunctionNodeAxisAngleToRotation", nullptr, ICON_AXIS_ANGLE_TO_ROTATION, "Add a Axis Angle to Rotation Function node\nConverts a axis angle to a rotation vector");
  define("FunctionNode", "FunctionNodeBooleanMath", nullptr, ICON_BOOLEAN_MATH, "Add a Boolean Math Function node\nPerforms a basic logical operation between its inputs");
  define("FunctionNode", "FunctionNodeCombineColor", nullptr, ICON_COMBINE_COLOR, "Add a Combine Color Function node\nCombines single colors to a rgb, hsv or hsl color value");
  define("FunctionNode", "FunctionNodeCombineMatrix", nullptr, ICON_COMBINE_MATRIX, "Add a Combine Matrix Function node\nConstruct a 4x4 matrix from its individual values");
  define("FunctionNode", "FunctionNodeCombineTransform", nullptr, ICON_COMBINE_TRANSFORM, "Add a Combine Transform Function node\n Combines the transform of matrices");
  define("FunctionNode", "FunctionNodeCompare", nullptr, ICON_FLOAT_COMPARE, "Add a Compare Function node\nAdds a mathematical compare between two inputs");
  define("FunctionNode", "FunctionNodeEulerToRotation", nullptr, ICON_EULER_TO_ROTATION, "Add a Euler to Rotation Function node\nConverts a euler angle to a rotation vector");
  define("FunctionNode", "FunctionNodeFindInString", nullptr, ICON_NONE, "");
  define("FunctionNode", "FunctionNodeFloatToInt", def_float_to_int, ICON_FLOAT_TO_INT, "Add a Float to Integer Function node\nConverts float values into integer values");
  define("FunctionNode", "FunctionNodeHashValue", nullptr, ICON_HASH, "Add a Hash Value node\nShows a hash value");
  define("FunctionNode", "FunctionNodeInputBool", def_fn_input_bool, ICON_INPUT_BOOL, "Add a Boolean Function node\nAdds a boolean that can be on or off");
  define("FunctionNode", "FunctionNodeInputColor", def_fn_input_color, ICON_COLOR, "Add a Color Function node\nAdds a color picker that allows you to set a color");
  define("FunctionNode", "FunctionNodeInputInt", def_fn_input_int, ICON_INTEGER, "Add a Integer Function node\nAllows to add a integer number");
  define("FunctionNode", "FunctionNodeInputRotation", def_fn_input_rotation, ICON_ROTATION, "Add a Rotation Function node\nAllows a constant rotation");
  define("FunctionNode", "FunctionNodeInputSpecialCharacters", nullptr, ICON_SPECIAL, "Add a Special Character Function node\nAdd special characters");
  define("FunctionNode", "FunctionNodeInputString", def_fn_input_string, ICON_STRING, "Add a String Function node\nAdds a string");
  define("FunctionNode", "FunctionNodeInputVector", def_fn_input_vector, ICON_NODE_VECTOR, "Add a Vector Function Function node\nCreates a single vector of three values that can be used as an input");
  define("FunctionNode", "FunctionNodeIntegerMath", nullptr, ICON_INTEGER_MATH, "Add a Integer Math node\nCreates a math node that works with integers");
  define("FunctionNode", "FunctionNodeInvertMatrix", nullptr, ICON_INVERT_MATRIX, "Add a Invert Matrix node\nInverts the matrix");
  define("FunctionNode", "FunctionNodeInvertRotation", nullptr, ICON_INVERT_ROTATION, "Add a Invert Rotation Function node\nInverts a rotation verctor");
  define("FunctionNode", "FunctionNodeMatrixDeterminant", nullptr, ICON_NONE, "Add a Matrix Determinant node");
  define("FunctionNode", "FunctionNodeMatrixMultiply", nullptr, ICON_MULTIPLY_MATRIX, "Add a Multiply Matrices Function node\nMultiplies the matrices");
  define("FunctionNode", "FunctionNodeProjectPoint", nullptr, ICON_PROJECT_POINT, "Add a Project Point Function node\nProject a point using a matrix, using location, rotation, scale, and perspective divide");
  define("FunctionNode", "FunctionNodeQuaternionToRotation", nullptr, ICON_QUATERNION_TO_ROTATION, "Add a Quaternion to Rotation Function node\nConverts a axis angle to a rotation vector");
  define("FunctionNode", "FunctionNodeRandomValue", def_fn_random_value, ICON_RANDOM_FLOAT, "Add a Random Value Function node\nAdds a random value");
  define("FunctionNode", "FunctionNodeReplaceString", nullptr, ICON_REPLACE_STRING, "Add a Replace String Function node\nAllows you to replace a string");
  define("FunctionNode", "FunctionNodeRotateEuler", def_fn_rotate_euler, ICON_ROTATE_EULER, "Add a Rotate Euler Function node\nRotate in euler angles");
  define("FunctionNode", "FunctionNodeRotateRotation", nullptr, ICON_ROTATE_EULER, "Add a Rotate Rotation node\nRotate euler by another euler angle");
  define("FunctionNode", "FunctionNodeRotateVector", nullptr, ICON_NODE_VECTORROTATE, "Add a Rotate Vector Function node\nRotate by a rotation vector");
  define("FunctionNode", "FunctionNodeRotationToAxisAngle", nullptr, ICON_ROTATION_TO_AXIS_ANGLE, "Add a Rotation to Axis Angle Function node\nConverts a rotation vector to a axis angle");
  define("FunctionNode", "FunctionNodeRotationToEuler", nullptr, ICON_ROTATION_TO_EULER, "Add a Rotation to Euler Function node\nConverts a rotation vector to an euler angle vector");
  define("FunctionNode", "FunctionNodeRotationToQuaternion", nullptr, ICON_ROTATION_TO_QUATERNION, "Add a Rotation to Quaternion Function node\nConverts a rotation vector to an quaternion angle vector");
  define("FunctionNode", "FunctionNodeSeparateColor", nullptr, ICON_SEPARATE_COLOR, "Add a Separate Color Function node\nSeparates the values of a rgb, hsv or hsl color into its single values");
  define("FunctionNode", "FunctionNodeSeparateMatrix", nullptr, ICON_SEPARATE_MATRIX, "Add a Separate Matrix Function node\nSplit a 4x4 matrix into its individual values");
  define("FunctionNode", "FunctionNodeSeparateTransform", nullptr, ICON_SEPARATE_TRANSFORM, "Add a Separate Transform node\nSeparates the transform values of matrices");
  define("FunctionNode", "FunctionNodeSliceString", nullptr, ICON_STRING_SUBSTRING, "Add a Slice String Function node\nAllows to slice an input string");
  define("FunctionNode", "FunctionNodeStringLength", nullptr, ICON_STRING_LENGTH, "Add a String Length Function node\nCalculate the length of a string");
  define("FunctionNode", "FunctionNodeTransformDirection", nullptr, ICON_TRANSFORM_DIRECTION, "Add a Transform Direction node\nRetreive the transform direction");
  define("FunctionNode", "FunctionNodeTransformPoint", nullptr, ICON_TRANSFORM_POINT, "Add a Transform Point node\nRetreive the transform point");
  define("FunctionNode", "FunctionNodeTransposeMatrix", nullptr, ICON_TRANSPOSE_MATRIX, "Add a Transpose Matrix node\nRetreive the transpose matrix");
  define("FunctionNode", "FunctionNodeValueToString", nullptr, ICON_VALUE_TO_STRING, "Add a Value to String Function node\nConverts a value to a text string");

  define("GeometryNode", "GeometryNodeAccumulateField", nullptr, ICON_ACCUMULATE, "Add a Accumulate Field Geometry node\nAdd the values of an evaluated field together and output the running total for each element");
  define("GeometryNode", "GeometryNodeAttributeDomainSize", nullptr, ICON_DOMAIN_SIZE, "Add a Domain Size Geometry node\nRetrieve the number of elements in a geometry for each attribute domain");
  define("GeometryNode", "GeometryNodeAttributeStatistic", nullptr, ICON_ATTRIBUTE_STATISTIC, "Add a Attribute Statistic Geometry node\nCalculate statistics about a data set from a field evaluated on a geometry");
  define("GeometryNode", "GeometryNodeBake", rna_def_geo_bake, ICON_BAKE, "Add a Bake Geometry node\nCache the incoming data so that it can be used without recomputation");
  define("GeometryNode", "GeometryNodeBlurAttribute", nullptr, ICON_BLUR_ATTRIBUTE, "Add a Blur Attribute Geometry node\nMix attribute values of neighboring elements");
  define("GeometryNode", "GeometryNodeBoundBox", nullptr, ICON_PIVOT_BOUNDBOX, "Add a Bounding Box Geometry node\nCalculate the limits of a geometry's positions and generate a box mesh with those dimensions");
  define("GeometryNode", "GeometryNodeCaptureAttribute", rna_def_geo_capture_attribute, ICON_ATTRIBUTE_CAPTURE, "Add a Capture Attribute Geometry node\nStore the result of a field on a geometry and output the data as a node socket. Allows remembering or interpolating data as the geometry changes, such as positions before deformation");
  define("GeometryNode", "GeometryNodeCollectionInfo", nullptr, ICON_COLLECTION_INFO, "Add a Collection Info Geometry node\nRetrieve geometry instances from a collection");
  define("GeometryNode", "GeometryNodeConvexHull", nullptr, ICON_CONVEXHULL, "Add a Convex Hull Geometry node\nCreate a mesh that encloses all points in the input geometry with the smallest number of points");
  define("GeometryNode", "GeometryNodeCornersOfEdge", nullptr, ICON_CORNERS_OF_EDGE, "Add a Corners of Edge Geometry node\nRetrieve face corners connected to edges");
  define("GeometryNode", "GeometryNodeCornersOfFace", nullptr, ICON_CORNERS_OF_FACE, "Add a Corners of Face Geometry node\nRetrieve corners that make up a face");
  define("GeometryNode", "GeometryNodeCornersOfVertex", nullptr, ICON_CORNERS_OF_VERTEX, "Add a Corners of Vertex Geometry node\nRetrieve face corners connected to vertices");
  define("GeometryNode", "GeometryNodeCurveArc", nullptr, ICON_CURVE_ARC, "Add a Arc Geometry node\nGenerate a poly spline arc");
  define("GeometryNode", "GeometryNodeCurveEndpointSelection", nullptr, ICON_SELECT_LAST, "Add a Endpoint Selection Geometry node\nProvide a selection for an arbitrary number of endpoints in each spline");
  define("GeometryNode", "GeometryNodeCurveHandleTypeSelection", def_geo_curve_handle_type_selection, ICON_SELECT_HANDLETYPE, "Add a Handle Type Selection Geometry node\nProvide a selection based on the handle types of Bézier control points");
  define("GeometryNode", "GeometryNodeCurveLength", nullptr, ICON_PARTICLEBRUSH_LENGTH, "Add a Curve Length Geometry node\nRetrieve the length of all splines added together");
  define("GeometryNode", "GeometryNodeCurveOfPoint", nullptr, ICON_CURVE_OF_POINT, "Add a Curve of Point Geometry node\nRetrieve the curve a control point is part of");
  define("GeometryNode", "GeometryNodeCurvePrimitiveBezierSegment", nullptr, ICON_CURVE_BEZCURVE, "Add a Bezier Segment Geometry node\nGenerate a 2D Bézier spline from the given control points and handles");
  define("GeometryNode", "GeometryNodeCurvePrimitiveCircle", nullptr, ICON_CURVE_BEZCIRCLE, "Add a Curve Circle Geometry node\nGenerate a poly spline circle");
  define("GeometryNode", "GeometryNodeCurvePrimitiveLine", nullptr, ICON_CURVE_LINE, "Add a Curve Line Geometry node\nGenerate a poly spline line with two points");
  define("GeometryNode", "GeometryNodeCurvePrimitiveQuadrilateral", nullptr, ICON_CURVE_QUADRILATERAL, "Add a Curve Quadrilateral node\nGenerate a polygon with four points");
  define("GeometryNode", "GeometryNodeCurveQuadraticBezier", nullptr, ICON_CURVE_NCURVE, "Add a Quadratic Bezier Geometry node\nGenerate a poly spline in a parabola shape with control points positions");
  define("GeometryNode", "GeometryNodeCurveSetHandles", def_geo_curve_set_handle_type, ICON_HANDLE_AUTO, "Add a Set Handle Type Geometry node\nSet the handle type for the control points of a Bézier curve");
  define("GeometryNode", "GeometryNodeCurveSpiral", nullptr, ICON_CURVE_SPIRAL, "Add a Spiral Geometry node\nGenerate a poly spline in a spiral shape");
  define("GeometryNode", "GeometryNodeCurveSplineType", nullptr, ICON_SPLINE_TYPE, "Add a Set Spline Type Geometry node\nChange the type of curves");
  define("GeometryNode", "GeometryNodeCurveStar", nullptr, ICON_CURVE_STAR, "Add a Star Geometry node\nGenerate a poly spline in a star pattern by connecting alternating points of two circles");
  define("GeometryNode", "GeometryNodeCurvesToGreasePencil", nullptr, ICON_OUTLINER_OB_GREASEPENCIL, "Add Curves to Grease Pencil node\nConvert the curves in each top-level instance into Grease Pencil layer");
  define("GeometryNode", "GeometryNodeCurveToMesh", nullptr, ICON_OUTLINER_OB_MESH, "Add a Curve to Mesh Geometry node\nConvert curves into a mesh, optionally with a custom profile shape defined by curves");
  define("GeometryNode", "GeometryNodeCurveToPoints", nullptr, ICON_POINTCLOUD_DATA, "Add a Curve to Points Geometry node\nGenerate a point cloud by sampling positions along curves");
  define("GeometryNode", "GeometryNodeDeformCurvesOnSurface", nullptr, ICON_DEFORM_CURVES, "Add a Deform Curves on Surface Geometry node\nTranslate and rotate curves based on changes between the object's original and evaluated surface mesh");
  define("GeometryNode", "GeometryNodeDeleteGeometry", nullptr, ICON_DELETE, "Add a Delete Geometry Geometry node\nRemove selected elements of a geometry");
  define("GeometryNode", "GeometryNodeDistributePointsInGrid", nullptr, ICON_NONE, "Add a Distribute Points in Grid node\nRGenerate points inside a volume grid");
  define("GeometryNode", "GeometryNodeDistributePointsInVolume", nullptr, ICON_VOLUME_DISTRIBUTE, "Add a Distribute Points in Volume Geometry node\nGenerate points inside a volume");
  define("GeometryNode", "GeometryNodeDistributePointsOnFaces", def_geo_distribute_points_on_faces, ICON_POINT_DISTRIBUTE, "Add a Distribute Points on Faces Geometry node\nGenerate points spread out on the surface of a mesh");
  define("GeometryNode", "GeometryNodeDualMesh", nullptr, ICON_DUAL_MESH, "Add a Dual Mesh Geometry node\nConvert Faces into vertices and vertices into faces");
  define("GeometryNode", "GeometryNodeDuplicateElements", nullptr, ICON_DUPLICATE, "Add a Duplicate Elements Geometry Node\nDuplicates the selected mesh element");
  define("GeometryNode", "GeometryNodeEdgePathsToCurves", nullptr, ICON_EDGE_PATHS_TO_CURVES, "Add a Edge Paths to Curves Geometry Node\nConverts Edge Paths to curves");
  define("GeometryNode", "GeometryNodeEdgePathsToSelection", nullptr, ICON_EDGE_PATH_TO_SELECTION, "Add a Edge Paths to Selection Geometry Node\nDefines a edge path with given input vertices and converts it to a selection");
  define("GeometryNode", "GeometryNodeEdgesOfCorner", nullptr, ICON_EDGES_OF_CORNER, "Add a Edges of Corner Geometry node\nRetrieve the edges on both sides of a face corner");
  define("GeometryNode", "GeometryNodeEdgesOfVertex", nullptr, ICON_EDGES_OF_VERTEX, "Add a Edges of Vertex Geometry node\nRetrieve the edges connected to each vertex");
  define("GeometryNode", "GeometryNodeEdgesToFaceGroups", nullptr, ICON_FACEGROUP, "Add a Edges to Face Groups Geometry Node\nGroup faces into regions surrounded by the selected boundary edges");
  define("GeometryNode", "GeometryNodeExtrudeMesh", nullptr, ICON_EXTRUDE_REGION, "Add a Extrude Mesh Geometry node\nGenerate new vertices, edges, or faces from selected elements and move them based on an offset while keeping them connected by their boundary");
  define("GeometryNode", "GeometryNodeFaceOfCorner", nullptr, ICON_FACE_OF_CORNER, "Add a Face of Corner Geometry node\nRetrieve the face each face corner is part of");
  define("GeometryNode", "GeometryNodeFieldAtIndex", nullptr, ICON_FIELD_AT_INDEX, "Add a Evaluate at Index Geometry Node\nRetrieve data of other elements in the context's geometry");
  define("GeometryNode", "GeometryNodeFieldOnDomain", nullptr, ICON_FIELD_DOMAIN, "Add a Evaluate on Domain Geometry Node\nRRetrieve values from a field on a different domain besides the domain from the context");
  define("GeometryNode", "GeometryNodeFillCurve", nullptr, ICON_CURVE_FILL, "Add a Fill Curve Geometry node\nGenerate a mesh on the XY plane with faces on the inside of input curves");
  define("GeometryNode", "GeometryNodeFilletCurve", nullptr, ICON_CURVE_FILLET, "Add a Fillet Curve Geometry node\nRound corners by generating circular arcs on each control point");
  define("GeometryNode", "GeometryNodeFlipFaces", nullptr, ICON_FLIP_NORMALS, "Add a Flip Faces Geometry node\nReverse the order of the vertices and edges of selected faces, flipping their normal direction");
  define("GeometryNode", "GeometryNodeForeachGeometryElementInput", def_geo_foreach_geometry_element_input, ICON_NONE, "Add a For Each Element Input node\nFor Each Geometry Element Input used to start a series of operations for each element");
  define("GeometryNode", "GeometryNodeForeachGeometryElementOutput", def_geo_foreach_geometry_element_output, ICON_NONE, "Add a For Each Element Output node\nFor Each Geometry Element Output used to end a series of operations for each element");
  define("GeometryNode", "GeometryNodeGeometryToInstance", nullptr, ICON_GEOMETRY_INSTANCE, "Add a Geometry to Instance Geometry node\nConvert each input geometry into an instance, which can be much faster than the Join Geometry node when the inputs are large");
  define("GeometryNode", "GeometryNodeGetNamedGrid", nullptr, ICON_NONE, "Add a Get Named Grid node\nGet volume grid from a volume geometry with the specified name");
  define("GeometryNode", "GeometryNodeGizmoDial", nullptr, ICON_DIAL_GIZMO, "Add a Dial Gizmo node\nShow a dial gizmo in the viewport for a value");
  define("GeometryNode", "GeometryNodeGizmoLinear", nullptr, ICON_LINEAR_GIZMO, "Add a Linear Gizmo node\nShow a linear gizmo in the viewport for a value");
  define("GeometryNode", "GeometryNodeGizmoTransform", rna_def_geo_gizmo_transform, ICON_TRANSFORM_GIZMO, "Add a Transform Gizmo node\nShow a transform gizmo in the viewport");
  define("GeometryNode", "GeometryNodeGreasePencilToCurves", nullptr, ICON_OUTLINER_OB_CURVES, "Add Grease Pencil to Curves node\nConvert Grease Pencil layers into curve instances");
  define("GeometryNode", "GeometryNodeGridToMesh", nullptr, ICON_NONE, "Add a Grid to Mesh node\nGenerate a mesh on the \"surface\" of a volume grid");
  define("GeometryNode", "GeometryNodeImageInfo", nullptr, ICON_IMAGE_INFO, "Add an Image Info Geometry node\nRetrieve information about an image");
  define("GeometryNode", "GeometryNodeImageTexture", def_geo_image_texture, ICON_IMAGE_DATA, "Add an Image Texture node\nSample values from an image texture");
  define("GeometryNode", "GeometryNodeImportOBJ", nullptr, ICON_NONE, "Add an Import OBJ node\nImport geometry from an OBJ file");
  define("GeometryNode", "GeometryNodeImportPLY", nullptr, ICON_NONE, "Add an Import PLY node\nImport a point cloud from a PLY file");
  define("GeometryNode", "GeometryNodeImportSTL", nullptr, ICON_NONE, "Add an Import STL node\nImport a mesh from an STL file");
  define("GeometryNode", "GeometryNodeIndexOfNearest", nullptr, ICON_INDEX_OF_NEAREST, "Add an Index of Nearest node\nFind the nearest element in a group. Similar to the \"Sample Nearest\" node");
  define("GeometryNode", "GeometryNodeIndexSwitch", def_geo_index_switch, ICON_INDEX_SWITCH, "Add an Index Switch node\nChoose between an arbitrary number of values with an index");
  define("GeometryNode", "GeometryNodeInputActiveCamera", nullptr, ICON_VIEW_SWITCHTOCAM, "Add an Active Camera node\nRetrieve the scene's active camera");
  define("GeometryNode", "GeometryNodeInputCollection", def_geo_input_collection, ICON_NONE, "Add an Input Collection node\nOutput a single collection");
  define("GeometryNode", "GeometryNodeInputCurveHandlePositions", nullptr, ICON_CURVE_HANDLE_POSITIONS, "Add a Curve Handle Positions node\nRetrieve the position of each Bézier control point's handles");
  define("GeometryNode", "GeometryNodeInputCurveTilt", nullptr, ICON_CURVE_TILT, "Add a Curve Tilt node\nRetrieve the angle at each control point used to twist the curve's normal around its tangent");
  define("GeometryNode", "GeometryNodeInputEdgeSmooth", nullptr, ICON_SHADING_EDGE_SMOOTH, "Add a Is Edge Smooth node\nSRetrieve whether each edge is marked for smooth or split normals");
  define("GeometryNode", "GeometryNodeInputID", nullptr, ICON_GET_ID, "Add an ID node\nRetrieve a stable random identifier value from the \"id\" attribute on the point domain, or the index if the attribute does not exist");
  define("GeometryNode", "GeometryNodeInputImage", def_geo_image, ICON_FILE_IMAGE, "Add an Image Input node\nInput image");
  define("GeometryNode", "GeometryNodeInputIndex", nullptr, ICON_INDEX, "Add a Index node\nRetrieve an integer value indicating the position of each element in the list, starting at zero");
  define("GeometryNode", "GeometryNodeInputInstanceRotation", nullptr, ICON_INSTANCE_ROTATE, "Add a Instance Rotation node\nRetrieve the rotation of each instance in the geometry");
  define("GeometryNode", "GeometryNodeInputInstanceScale", nullptr, ICON_INSTANCE_SCALE, "Add a Instanec Scale node\nRetrieve the scale of each instance in the geometry");
  define("GeometryNode", "GeometryNodeInputMaterial", def_geo_input_material, ICON_NODE_MATERIAL, "Add a Material node\nOutput a single material");
  define("GeometryNode", "GeometryNodeInputMaterialIndex", nullptr, ICON_MATERIAL_INDEX, "Add a Material Index node\nRetrieve the index of the material used for each element in the geometry's list of materials");
  define("GeometryNode", "GeometryNodeInputMeshEdgeAngle", nullptr, ICON_EDGE_ANGLE, "Add an Edge Angle node\nThe angle between the normals of connected manifold faces");
  define("GeometryNode", "GeometryNodeInputMeshEdgeNeighbors", nullptr, ICON_EDGE_NEIGHBORS, "Add an Edge neighbors node\nRetrieve the number of faces that use each edge as one of their sides");
  define("GeometryNode", "GeometryNodeInputMeshEdgeVertices", nullptr, ICON_EDGE_VERTICES, "Add an Edge Vertices node\nRetrieve topology information relating to each edge of a mesh");
  define("GeometryNode", "GeometryNodeInputMeshFaceArea", nullptr, ICON_FACEREGIONS, "Add a Face Area node\nCalculate the surface area of a mesh's faces");
  define("GeometryNode", "GeometryNodeInputMeshFaceIsPlanar", nullptr, ICON_PLANAR, "Add a Is Face Planar node\nRetrieve whether all triangles in a face are on the same plane, i.e. whether they have the same normal");
  define("GeometryNode", "GeometryNodeInputMeshFaceNeighbors", nullptr, ICON_FACE_NEIGHBORS, "Add a Face Neighbors node\nRetrieve topology information relating to each face of a mesh");
  define("GeometryNode", "GeometryNodeInputMeshIsland", nullptr, ICON_UV_ISLANDSEL, "Add a Mesh Island node\nRetrieve information about separate connected regions in a mesh");
  define("GeometryNode", "GeometryNodeInputMeshVertexNeighbors", nullptr, ICON_VERTEX_NEIGHBORS, "Add a Vertex Neighbors node\nRetrieve topology information relating to each vertex of a mesh");
  define("GeometryNode", "GeometryNodeInputNamedAttribute", nullptr, ICON_NAMED_ATTRIBUTE, "Add a Named Attributes node\nRetrieve the data of a specified attribute");
  define("GeometryNode", "GeometryNodeInputNamedLayerSelection", nullptr, ICON_NAMED_LAYER_SELECTION, "Add a Layere Selection Node\nOutput a selection of a Grease Pencil layer");
  define("GeometryNode", "GeometryNodeInputNormal", nullptr, ICON_RECALC_NORMALS, "Add a Normal node\nRetrieve a unit length vector indicating the direction pointing away from the geometry at each element");
  define("GeometryNode", "GeometryNodeInputObject", def_geo_input_object, ICON_NONE, "Add an Object Input node\nOutput a single object");
  define("GeometryNode", "GeometryNodeInputPosition", nullptr, ICON_POSITION, "Add a Position node\nRetrieve a vector indicating the location of each element");
  define("GeometryNode", "GeometryNodeInputRadius", nullptr, ICON_RADIUS, "Add a Radius node\nRetrieve the radius at each point on curve or point cloud geometry");
  define("GeometryNode", "GeometryNodeInputSceneTime", nullptr, ICON_TIME, "Add a Scene Time node\nRetrieve the current time in the scene's animation in units of seconds or frames");
  define("GeometryNode", "GeometryNodeInputShadeSmooth", nullptr, ICON_SHADING_SMOOTH, "Add a Is Shade Smooth node\nRetrieve whether each face is marked for smooth or sharp normals");
  define("GeometryNode", "GeometryNodeInputShortestEdgePaths", nullptr, ICON_SELECT_SHORTESTPATH, "Add a Shortest Edge Paths node\n Retrieve the shortest edge paths on select geometry");
  define("GeometryNode", "GeometryNodeInputSplineCyclic", nullptr, ICON_IS_SPLINE_CYCLIC, "Add a Is Spline Cyclic node\nRetrieve whether each spline endpoint connects to the beginning");
  define("GeometryNode", "GeometryNodeInputSplineResolution", nullptr, ICON_SPLINE_RESOLUTION, "Add a Spline Resolution node\nRetrieve the number of evaluated points that will be generated for every control point on curves");
  define("GeometryNode", "GeometryNodeInputTangent", nullptr, ICON_CURVE_TANGENT, "Add a Curve Tangent node\nRetrieve the direction of curves at each control point");
  define("GeometryNode", "GeometryNodeInstanceOnPoints", nullptr, ICON_POINT_INSTANCE, "Add a Instance on Points node\nGenerate a reference to geometry at each of the input points, without duplicating its underlying data");
  define("GeometryNode", "GeometryNodeInstancesToPoints", nullptr, ICON_INSTANCES_TO_POINTS, "Add a Instances to Points node\nGenerate points at the origins of instances.\nNote: Nested instances are not affected by this node");
  define("GeometryNode", "GeometryNodeInstanceTransform", nullptr, ICON_INSTANCE_TRANSFORM_GET, "Add a Instance Transform node\nRetrieve the full transformation of each instance in the geometry");
  define("GeometryNode", "GeometryNodeInterpolateCurves", nullptr, ICON_INTERPOLATE_CURVE, "Add a Interpolate Curves node\nGenerate new curves on points by interpolating between existing curves");
  define("GeometryNode", "GeometryNodeIsViewport", nullptr, ICON_VIEW, "Add a Is Viewport node\nRetrieve whether the nodes are being evaluated for the viewport rather than the final render");
  define("GeometryNode", "GeometryNodeJoinGeometry", nullptr, ICON_JOIN, "Add a Join Geometry node\nMerge separately generated geometries into a single one");
  define("GeometryNode", "GeometryNodeMaterialSelection", nullptr, ICON_SELECT_BY_MATERIAL, "Add a Material Selection node\nProvide a selection of faces that use the specified material");
  define("GeometryNode", "GeometryNodeMenuSwitch", def_geo_menu_switch, ICON_MENU_SWITCH, "Add a Menu Switch node\nSelect from multiple inputs by name");
  define("GeometryNode", "GeometryNodeMergeByDistance", nullptr, ICON_REMOVE_DOUBLES, "Add a Merge by Distance Geometry node\nMerge vertices or points within a given distance");
  define("GeometryNode", "GeometryNodeMergeLayers", nullptr, ICON_MERGE, "Add a Merge Layers node\nJoin groups of Grease Pencil layers into one");
  define("GeometryNode", "GeometryNodeMeshBoolean", nullptr, ICON_MOD_BOOLEAN, "Add a Mesh Boolean Geometry node\nCut, subtract, or join multiple mesh inputs");
  define("GeometryNode", "GeometryNodeMeshCircle", nullptr, ICON_MESH_CIRCLE, "Add a Mesh Circle Geometry node\nGenerate a circular ring of edges");
  define("GeometryNode", "GeometryNodeMeshCone", nullptr, ICON_MESH_CONE, "Add a Cone Geometry node\nGenerate a cone mesh");
  define("GeometryNode", "GeometryNodeMeshCube", nullptr, ICON_MESH_CUBE, "Add a Cube Geometry node\nGenerate a cuboid mesh with variable side lengths and subdivisions");
  define("GeometryNode", "GeometryNodeMeshCylinder", nullptr, ICON_MESH_CYLINDER, "Add a Cylinder Geometry node\nGenerate a cylinder mesh");
  define("GeometryNode", "GeometryNodeMeshFaceSetBoundaries", nullptr, ICON_SELECT_BOUNDARY, "Add a Face Group Boundaries Geometry node\nFind edges on the boundaries between groups of faces with the same ID value");
  define("GeometryNode", "GeometryNodeMeshGrid", nullptr, ICON_MESH_GRID, "Add a Grid Geometry node\nGenerate a planar mesh on the XY plane");
  define("GeometryNode", "GeometryNodeMeshIcoSphere", nullptr, ICON_MESH_ICOSPHERE, "Add a Ico Sphere Geometry node\nGenerate a spherical mesh that consists of equally sized triangles");
  define("GeometryNode", "GeometryNodeMeshLine", nullptr, ICON_MESH_LINE, "Add a Mesh Line Geometry node\nGenerate vertices in a line and connect them with edges");
  define("GeometryNode", "GeometryNodeMeshToCurve", nullptr, ICON_OUTLINER_OB_CURVE, "Add a Mesh to Curve Geometry node\nGenerate a curve from a mesh");
  define("GeometryNode", "GeometryNodeMeshToDensityGrid", nullptr, ICON_NONE, "Add a Mesh to Density Grid node\nCreate a filled volume grid from a mesh");
  define("GeometryNode", "GeometryNodeMeshToPoints", nullptr, ICON_MESH_TO_POINTS, "Add a Mesh to Points Geometry node\nGenerate a point cloud from a mesh's vertices");
  define("GeometryNode", "GeometryNodeMeshToSDFGrid", nullptr, ICON_NONE, "Add a Mesh to SDF Grid node\nCreate a signed distance volume grid from a mesh");
  define("GeometryNode", "GeometryNodeMeshToVolume", nullptr, ICON_MESH_TO_VOLUME, "Add a Mesh to Volume Geometry node\nCreate a fog volume with the shape of the input mesh's surface");
  define("GeometryNode", "GeometryNodeMeshUVSphere", nullptr, ICON_MESH_UVSPHERE, "Add a UV Sphere Geometry node\nGenerate a spherical mesh with quads, except for triangles at the top and bottom");
  define("GeometryNode", "GeometryNodeObjectInfo", nullptr, ICON_NODE_OBJECTINFO, "Add a Object Info Geometry node\nRetrieve information from an object");
  define("GeometryNode", "GeometryNodeOffsetCornerInFace", nullptr, ICON_OFFSET_CORNER_IN_FACE, "Add a Offset Corner in Face Geometry node\nRetrieve corners in the same face as another");
  define("GeometryNode", "GeometryNodeOffsetPointInCurve", nullptr, ICON_OFFSET_POINT_IN_CURVE, "Add a Offset Point in Curve Geometry node\nOffset a control point index within its curve");
  define("GeometryNode", "GeometryNodePoints", nullptr, ICON_DECORATE, "Add a Points Geometry node\nGenerate a point cloud with positions and radii defined by fields");
  define("GeometryNode", "GeometryNodePointsOfCurve", nullptr, ICON_POINT_OF_CURVE, "Add a Points of Curve Geometry node\nRetrieve a point index within a curve");
  define("GeometryNode", "GeometryNodePointsToCurves", nullptr, ICON_POINTS_TO_CURVES, "Add a Points to Curves node\nSplit all points to curve by its group ID and reorder by weight");
  define("GeometryNode", "GeometryNodePointsToSDFGrid", nullptr, ICON_NONE, "Add a Points to SDF Grid node\nCreate a signed distance volume grid from points");
  define("GeometryNode", "GeometryNodePointsToVertices", nullptr, ICON_POINTS_TO_VERTICES, "Add a Points to Vertices Geometry node\nGenerate a mesh vertex for each point cloud point");
  define("GeometryNode", "GeometryNodePointsToVolume", nullptr, ICON_POINT_TO_VOLUME, "Add a Points to Volume Geometry node\nGenerate a fog volume sphere around every point");
  define("GeometryNode", "GeometryNodeProximity", nullptr, ICON_GEOMETRY_PROXIMITY, "Add a Switch Geometry node\nCompute the closest location on the target geometry");
  define("GeometryNode", "GeometryNodeRaycast", nullptr, ICON_RAYCAST, "Add a Raycast Geometry node\nCast rays from the context geometry onto a target geometry, and retrieve information from each hit point");
  define("GeometryNode", "GeometryNodeRealizeInstances", nullptr, ICON_MOD_INSTANCE, "Add a Realize Instances Geometry node\nConvert instances into real geometry data");
  define("GeometryNode", "GeometryNodeRemoveAttribute", nullptr, ICON_ATTRIBUTE_REMOVE, "Add a Remove Named Attribute Geometry node\nDelete an attribute with a specified name from a geometry. Typically used to optimize performance");
  define("GeometryNode", "GeometryNodeRepeatInput", def_geo_repeat_input, ICON_REPEAT, "Add a Repeat Input  Geometry node\nStarts a serial loop for a chain of nodes a number of times");
  define("GeometryNode", "GeometryNodeRepeatOutput", def_geo_repeat_output, ICON_REPEAT, "Add a Repeat Output Geometry node\nEnds a serial loop for a chain of nodes a number of times");
  define("GeometryNode", "GeometryNodeReplaceMaterial", nullptr, ICON_MATERIAL_REPLACE, "Add a Replace Material Geometry node\n\nSwap one material with another");
  define("GeometryNode", "GeometryNodeResampleCurve", nullptr, ICON_CURVE_RESAMPLE, "Add a Resample Curve Geometry node\nGenerate a poly spline for each input spline");
  define("GeometryNode", "GeometryNodeReverseCurve", nullptr, ICON_SWITCH_DIRECTION, "Add a Reverse Curve Geometry node\nChange the direction of curves by swapping their start and end data");
  define("GeometryNode", "GeometryNodeRotateInstances", nullptr, ICON_ROTATE_INSTANCE, "Add a Rotate Instances Geometry node\nRotate geometry instances in local or global space");
  define("GeometryNode", "GeometryNodeSampleCurve", def_geo_curve_sample, ICON_CURVE_SAMPLE, "Add a Sample Curve Geometry node\nRetrieve data from a point on a curve at a certain distance from its start");
  define("GeometryNode", "GeometryNodeSampleGrid", nullptr, ICON_NONE, "");
  define("GeometryNode", "GeometryNodeSampleGridIndex", nullptr, ICON_NONE, "Add a Sample Grid Index node\nRetrieve volume grid values at specific voxels");
  define("GeometryNode", "GeometryNodeSampleIndex", def_geo_sample_index, ICON_SAMPLE_INDEX, "Add a Sample Index Geometry node\nRetrieve values from specific geometry elements");
  define("GeometryNode", "GeometryNodeSampleNearest", nullptr, ICON_SAMPLE_NEAREST, "Add a Sample Nearest Geometry node\nFind the element of a geometry closest to a position. Similar to the \"Index of Nearest\" node");
  define("GeometryNode", "GeometryNodeSampleNearestSurface", nullptr, ICON_SAMPLE_NEAREST_SURFACE, "Add a Sample Nearest Surface Geometry node\nCalculate the interpolated value of a mesh attribute on the closest point of its surface");
  define("GeometryNode", "GeometryNodeSampleUVSurface", nullptr, ICON_SAMPLE_UV_SURFACE, "Add a Sample UV Surface Geometry node\nCalculate the interpolated values of a mesh attribute at a UV coordinate");
  define("GeometryNode", "GeometryNodeScaleElements", nullptr, ICON_TRANSFORM_SCALE, "Add a Scale Elements Geometry node\nScale groups of connected edges and faces");
  define("GeometryNode", "GeometryNodeScaleInstances", nullptr, ICON_SCALE_INSTANCE, "Add a Scale Instances Geometry node\nScale geometry instances in local or global space");
  define("GeometryNode", "GeometryNodeSDFGridBoolean", nullptr, ICON_NONE, "Add a SDF Grid Boolean node\nCut, subtract, or join multiple SDF volume grid inputs");
  define("GeometryNode", "GeometryNodeSelfObject", nullptr, ICON_SELF_OBJECT, "Add a Self Object Geometry node\nRetrieve the object that contains the geometry nodes modifier currently being executed");
  define("GeometryNode", "GeometryNodeSeparateComponents", nullptr, ICON_SEPARATE, "Add a Separate Components Geometry node\nSplit a geometry into a separate output for each type of data in the geometry");
  define("GeometryNode", "GeometryNodeSeparateGeometry", nullptr, ICON_SEPARATE_GEOMETRY, "Add a Separate Geometry Geometry node\nSplit a geometry into two geometry outputs based on a selection");
  define("GeometryNode", "GeometryNodeSetCurveHandlePositions", nullptr, ICON_SET_CURVE_HANDLE_POSITIONS, "Add a Set Handle Positions Geometry node\nSet the positions for the handles of Bézier curves");
  define("GeometryNode", "GeometryNodeSetCurveNormal", nullptr, ICON_CURVE_NORMAL, "Add a Set Curve Normal Geometry node\nSet the evaluation mode for curve normals");
  define("GeometryNode", "GeometryNodeSetCurveRadius", nullptr, ICON_SET_CURVE_RADIUS, "Add a Set Curve Radius Geometry node\nSet the radius of the curve at each control point");
  define("GeometryNode", "GeometryNodeSetCurveTilt", nullptr, ICON_SET_CURVE_TILT, "Add a Set Curve Tilt Geometry node\nSet the tilt angle at each curve control point");
  define("GeometryNode", "GeometryNodeSetGeometryName", nullptr, ICON_GEOMETRY_NAME, "Add a Set Geometry Name node\nSet the name of a geometry for easier debugging");
  define("GeometryNode", "GeometryNodeSetID", nullptr, ICON_SET_ID, "Add a Set ID Geometry node\nSet the id attribute on the input geometry, mainly used internally for randomizing");
  define("GeometryNode", "GeometryNodeSetInstanceTransform", nullptr, ICON_INSTANCE_TRANSFORM, "Add a Set Instance Transform node\nSet the transformation matrix of every instance");
  define("GeometryNode", "GeometryNodeSetMaterial", nullptr, ICON_MATERIAL_ADD, "Add a Set Material Geometry node\nAssign a material to geometry elements");
  define("GeometryNode", "GeometryNodeSetMaterialIndex", nullptr, ICON_SET_MATERIAL_INDEX, "Add a Set Material Index Geometry node\nSet the material index for each selected geometry element");
  define("GeometryNode", "GeometryNodeSetPointRadius", nullptr, ICON_SET_CURVE_RADIUS, "Add a Set Point Radius Geometry node\nSet the display size of point cloud points");
  define("GeometryNode", "GeometryNodeSetPosition", nullptr, ICON_SET_POSITION, "Add a Set Position Geometry node\nSet the location of each point");
  define("GeometryNode", "GeometryNodeSetShadeSmooth", nullptr, ICON_SET_SHADE_SMOOTH, "Add a Set Shade Smooth Geometry node\nControl the smoothness of mesh normals around each face by changing the \"shade smooth\" attribute");
  define("GeometryNode", "GeometryNodeSetSplineCyclic", nullptr, ICON_TOGGLE_CYCLIC, "Add a Set Spline Cyclic Geometry node\nControl whether each spline loops back on itself by changing the \"cyclic\" attribute");
  define("GeometryNode", "GeometryNodeSetSplineResolution", nullptr, ICON_SET_SPLINE_RESOLUTION, "Add a Set Spline Resolution Geometry node\nControl how many evaluated points should be generated on every curve segment");
  define("GeometryNode", "GeometryNodeSimulationInput", def_geo_simulation_input, ICON_TIME, "Add a Simulation Input Geometry node\nInput data for the simulation zone");
  define("GeometryNode", "GeometryNodeSimulationOutput", def_geo_simulation_output, ICON_TIME, "Add a Simulation Output Geometry node\nOutput data from the simulation zone");
  define("GeometryNode", "GeometryNodeSortElements", nullptr, ICON_SORTSIZE, "Add a Sort Elements node\nRearrange geometry elements, changing their indices");
  define("GeometryNode", "GeometryNodeSplineLength", nullptr, ICON_SPLINE_LENGTH, "Add a Spline Length node\nRetrieve the total length of each spline, as a distance or as a number of points");
  define("GeometryNode", "GeometryNodeSplineParameter", nullptr, ICON_CURVE_PARAMETER, "Add a Spline Parameter Geometry node\nRetrieve how far along each spline a control point is");
  define("GeometryNode", "GeometryNodeSplitEdges", nullptr, ICON_SPLITEDGE, "Add a Split Edges Geometry node\nDuplicate mesh edges and break connections with the surrounding faces");
  define("GeometryNode", "GeometryNodeSplitToInstances", nullptr, ICON_SPLIT_TO_INSTANCES, "Add a Split to Instances Geometry node\nCreate separate geometries containing the elements from the same group");
  define("GeometryNode", "GeometryNodeStoreNamedAttribute", nullptr, ICON_ATTRIBUTE_STORE, "Add a Store Named Attribute Geometry node\nStore the result of a field on a geometry as an attribute with the specified name");
  define("GeometryNode", "GeometryNodeStoreNamedGrid", nullptr, ICON_NONE, "Add a Store Named Grid node\nStore grid data in a volume geometry with the specified name");
  define("GeometryNode", "GeometryNodeStringJoin", nullptr, ICON_STRING_JOIN, "Add a Join Strings Geometry node\nCombine any number of input strings");
  define("GeometryNode", "GeometryNodeStringToCurves", def_geo_string_to_curves, ICON_STRING_TO_CURVE, "Add a String to Curves Geometry node\nGenerate a paragraph of text with a specific font, using a curve instance to store each character");
  define("GeometryNode", "GeometryNodeSubdivideCurve", nullptr, ICON_SUBDIVIDE_EDGES, "Add a Subdivide Curve Geometry node\nDividing each curve segment into a specified number of pieces");
  define("GeometryNode", "GeometryNodeSubdivideMesh", nullptr, ICON_SUBDIVIDE_MESH, "Add a Subdivide Mesh Geometry node\nDivide mesh faces into smaller ones without changing the shape or volume, using linear interpolation to place the new vertices");
  define("GeometryNode", "GeometryNodeSubdivisionSurface", nullptr, ICON_SUBDIVIDE_EDGES, "Add a Subdivision Surface Geometry node\nDivide mesh faces to form a smooth surface, using the Catmull-Clark subdivision method");
  define("GeometryNode", "GeometryNodeSwitch", nullptr, ICON_SWITCH, "Add a Switch Geometry node\nSwitch between two inputs");
  define("GeometryNode", "GeometryNodeTool3DCursor", nullptr, ICON_CURSOR, "Add a 3D Cursor Geometry node\nThe scene's 3D cursor location and rotation");
  define("GeometryNode", "GeometryNodeToolActiveElement", nullptr, ICON_ACTIVE_ELEMENT, "Add an Active Element node\nActive element indices of the edited geometry, for tool execution");
  define("GeometryNode", "GeometryNodeToolFaceSet", nullptr, ICON_FACE_SET, "Add a Face Set Geometry node\nEach face's sculpt face set value");
  define("GeometryNode", "GeometryNodeToolMousePosition", nullptr, ICON_MOUSE_POSITION, "Add a Mouse Position Geometry node\nRetrieve the position of the mouse cursor");
  define("GeometryNode", "GeometryNodeToolSelection", nullptr, ICON_RESTRICT_SELECT_OFF, "Add a Selection Geometry node\nUser selection of the edited geometry, for tool execution");
  define("GeometryNode", "GeometryNodeToolSetFaceSet", nullptr, ICON_SET_FACE_SET, "Add a Set Face Set Geometry node\nSet sculpt face set values for faces");
  define("GeometryNode", "GeometryNodeToolSetSelection", nullptr, ICON_SET_SELECTION, "Add a Set Selection Geometry node\nSet selection of the edited geometry, for tool execution");
  define("GeometryNode", "GeometryNodeTransform", nullptr, ICON_NODE_TRANSFORM, "Add a Transform Geometry Geometry node\nTranslate, rotate or scale the geometry");
  define("GeometryNode", "GeometryNodeTranslateInstances", nullptr, ICON_TRANSLATE_INSTANCE, "Add a Translate Instances Geometry node\nMove top-level geometry instances in local or global space");
  define("GeometryNode", "GeometryNodeTriangulate", nullptr, ICON_MOD_TRIANGULATE, "Add a Triangulate Geometry node\nConvert all faces in a mesh to triangular faces");
  define("GeometryNode", "GeometryNodeTrimCurve", nullptr, ICON_CURVE_TRIM, "Add a Trim Curve Geometry node\nShorten curves by removing portions at the start or end");
  define("GeometryNode", "GeometryNodeUVPackIslands", nullptr, ICON_PACKISLAND, "Add a Pack UV Islands Geometry node\nScale islands of a UV map and move them so they fill the UV space as much as possible");
  define("GeometryNode", "GeometryNodeUVUnwrap", nullptr, ICON_UNWRAP_ABF, "Add a UV Unwrap Geometry node\nGenerate a UV map based on seam edges");
  define("GeometryNode", "GeometryNodeVertexOfCorner", nullptr, ICON_VERTEX_OF_CORNER, "Add a Vertex of Corner Geometry node\nRetrieve the vertex each face corner is attached to");
  define("GeometryNode", "GeometryNodeViewer", nullptr, ICON_NODE_VIEWER, "Add a Viewer Geometry node\nDisplay the input data in the Spreadsheet Editor");
  define("GeometryNode", "GeometryNodeViewportTransform", nullptr, ICON_VIEWPORT_TRANSFORM, "Add a Viewport Transform node\nRetrieve the view direction and location of the 3D viewport");
  define("GeometryNode", "GeometryNodeVolumeCube", nullptr, ICON_VOLUME_CUBE, "Add a Volume Cube Geometry node\nGenerate a dense volume with a field that controls the density at each grid voxel based on its position");
  define("GeometryNode", "GeometryNodeVolumeToMesh", nullptr, ICON_VOLUME_TO_MESH, "Add a Volume to Mesh Geometry node\nGenerate a mesh on the \"surface\" of a volume");
  define("GeometryNode", "GeometryNodeWarning", nullptr, ICON_ERROR, "Add a Warning node\nCreate custom warnings in node groups");

  /* Node group types are currently defined for each tree type individually. */
  define("ShaderNode", "ShaderNodeGroup", def_group, ICON_NODE_MAKEGROUP, "Create a node group from the selected nodes");
  define("CompositorNode", "CompositorNodeGroup", def_group, ICON_NODE_MAKEGROUP, "Create a node group from the selected nodes");
  define("TextureNode", "TextureNodeGroup", def_group, ICON_NODE_MAKEGROUP, "Create a node group from the selected nodes");
  define("GeometryNode", "GeometryNodeGroup", def_group, ICON_NODE_MAKEGROUP, "Create a node group from the selected nodes");
