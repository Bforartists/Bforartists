...
DefNode(GeometryNode, GEO_NODE_EDGES_TO_FACE_GROUPS, 0, "EDGES_TO_FACE_GROUPS", EdgesToFaceGroups, "Edges to Face Groups", "Adds a Edges to Face Groups geometry node\nGroup faces into regions surrounded by the selected boundary edges")
