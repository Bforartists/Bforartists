...
DefNode(GeometryNode, GEO_NODE_INPUT_CURVE_HANDLES, 0, "INPUT_CURVE_HANDLES", InputCurveHandlePositions, "Get Curve Handle Positions", "Add a Get Curve Handle Positions Geometry Node\nRetreives the position of the curve handles")
DefNode(GeometryNode, GEO_NODE_INPUT_CURVE_TILT, 0, "INPUT_CURVE_TILT", InputCurveTilt, "Get Curve Tilt", "Add a Get Curve Tilt Geometry Node\nTilt a curve")
DefNode(GeometryNode, GEO_NODE_INPUT_ID, 0, "INPUT_ID", InputID, "Get ID", "Add a Get ID Geometry Node\nRetreives the Input ID")
...
DefNode(GeometryNode, GEO_NODE_INPUT_MATERIAL_INDEX, 0, "INPUT_MATERIAL_INDEX", InputMaterialIndex, "Get Material Index", "Add a Get Material Index Geometry Node\nRetreives the material index")
...
DefNode(GeometryNode, GEO_NODE_INPUT_POSITION, 0, "POSITION", InputPosition, "Get Position", "Add a Input Position Geometry node\nRetreives the input position of the geometry")
DefNode(GeometryNode, GEO_NODE_INPUT_RADIUS, 0, "INPUT_RADIUS", InputRadius, "Get Radius", "Add a Input Radius Geometry node\nRetreives the input radius")
