...
TexDef(TEX_VORONOI,
       ...
       "Voronoi",
       "TEX_VORONOI",
       "Generate Worley noise based on the distance to random points");
TexDef(TEX_BLEND,
       "TextureNodeTexBlend",
       C,
       blend,
       "Blend",
       "TEX_BLEND",
       "Generate a smoothly interpolated progression");
TexDef(TEX_MAGIC,
       "TextureNodeTexMagic",
       C,
       magic,
...
TexDef(TEX_MARBLE,
       ...
       "Marble",
       "TEX_MARBLE",
       "Generate marble-like bands based on the sine, saw, or triangular formula and noise "
       "turbulence");
TexDef(TEX_CLOUDS,
...
TexDef(TEX_MUSGRAVE,
       ...
       "Musgrave",
       "TEX_MUSGRAVE",
       "Generate a flexible fractal noise based on the specified mode");
TexDef(TEX_NOISE,
       "TextureNodeTexNoise",
       C,
       noise,
       "Noise",
       "TEX_NOISE",
       "Generate a random color based on an input seed");
TexDef(TEX_STUCCI,
       ...
       "Stucci",
       "TEX_STUCCI",
       "Generate noise characterized by multiple tiny bumps, resembling stucco");
TexDef(TEX_DISTNOISE,
       ...
       "Distorted Noise",
       "TEX_DISTNOISE",
       "Generate a hybrid pattern where one noise texture is distorted by another");
}  // namespace blender
