...
{
  return math::interpolate_nearest_border_byte(in->byte_data(), in->x, in->y, u, v);
}
[[nodiscard]] inline float4 interpolate_nearest_border_fl(const ImBuf *in, float u, float v)
{
  return math::interpolate_nearest_border_fl(in->float_data(), in->x, in->y, u, v);
}
inline void interpolate_nearest_border_byte(const ImBuf *in, uchar output[4], float u, float v)
{
  math::interpolate_nearest_border_byte(in->byte_data(), output, in->x, in->y, u, v);
}
inline void interpolate_nearest_border_fl(const ImBuf *in, float output[4], float u, float v)
{
  math::interpolate_nearest_border_fl(in->float_data(), output, in->x, in->y, 4, u, v);
}
...
{
  return math::interpolate_nearest_wrap_byte(in->byte_data(), in->x, in->y, u, v);
}
[[nodiscard]] inline float4 interpolate_nearest_wrap_fl(const ImBuf *in, float u, float v)
{
  return math::interpolate_nearest_wrap_fl(in->float_data(), in->x, in->y, u, v);
}
...
{
  return math::interpolate_bilinear_byte(in->byte_data(), in->x, in->y, u, v);
}
...
{
  uchar4 col = math::interpolate_bilinear_byte(in->byte_data(), in->x, in->y, u, v);
...
{
  return math::interpolate_bilinear_border_byte(in->byte_data(), in->x, in->y, u, v);
}
[[nodiscard]] inline float4 interpolate_bilinear_border_fl(const ImBuf *in, float u, float v)
{
  return math::interpolate_bilinear_border_fl(in->float_data(), in->x, in->y, u, v);
}
inline void interpolate_bilinear_border_byte(const ImBuf *in, uchar output[4], float u, float v)
{
  uchar4 col = math::interpolate_bilinear_border_byte(in->byte_data(), in->x, in->y, u, v);
  memcpy(output, &col, sizeof(col));
}
inline void interpolate_bilinear_border_fl(const ImBuf *in, float output[4], float u, float v)
{
  float4 col = math::interpolate_bilinear_border_fl(in->float_data(), in->x, in->y, u, v);
  memcpy(output, &col, sizeof(col));
}
...
{
  return math::interpolate_bilinear_wrap_byte(in->byte_data(), in->x, in->y, u, v);
}
[[nodiscard]] inline float4 interpolate_bilinear_wrap_fl(const ImBuf *in, float u, float v)
{
  return math::interpolate_bilinear_wrap_fl(in->float_data(), in->x, in->y, u, v);
}
...
{
  return math::interpolate_cubic_bspline_byte(in->byte_data(), in->x, in->y, u, v);
}
[[nodiscard]] inline float4 interpolate_cubic_bspline_fl(const ImBuf *in, float u, float v)
{
  return math::interpolate_cubic_bspline_fl(in->float_data(), in->x, in->y, u, v);
}
inline void interpolate_cubic_bspline_byte(const ImBuf *in, uchar output[4], float u, float v)
{
  uchar4 col = math::interpolate_cubic_bspline_byte(in->byte_data(), in->x, in->y, u, v);
  memcpy(output, &col, sizeof(col));
}
inline void interpolate_cubic_bspline_fl(const ImBuf *in, float output[4], float u, float v)
{
  float4 col = math::interpolate_cubic_bspline_fl(in->float_data(), in->x, in->y, u, v);
  memcpy(output, &col, sizeof(col));
}
...
{
  return math::interpolate_cubic_mitchell_byte(in->byte_data(), in->x, in->y, u, v);
}
inline void interpolate_cubic_mitchell_byte(const ImBuf *in, uchar output[4], float u, float v)
{
  uchar4 col = math::interpolate_cubic_mitchell_byte(in->byte_data(), in->x, in->y, u, v);
  memcpy(output, &col, sizeof(col));
}
