...
void OBJECT_OT_vertex_group_add(wmOperatorType *ot)
{
	...
	ot->description = "Add Vertex Group\nAdd a new vertex group to the active object";
...
void OBJECT_OT_vertex_group_remove(wmOperatorType *ot)
{
	...
	ot->description = "Remove Vertex Group\nDelete the active or all vertex groups from the active object";
...
void OBJECT_OT_vertex_group_assign_new(wmOperatorType *ot)
{
	...
	ot->description = "Assign to New Group\nAssign the selected vertices to a new vertex group";
...
void OBJECT_OT_vertex_group_copy(wmOperatorType *ot)
{
	...
	ot->description = "Copy Vertex Group\nMake a copy of the active vertex group";
...
void OBJECT_OT_vertex_group_levels(wmOperatorType *ot)
{
	...
	ot->description = "Vertex Group Levels\nAdd some offset and multiply with some gain the weights of the active vertex group";
...
void OBJECT_OT_vertex_group_normalize_all(wmOperatorType *ot)
{
	...
	ot->description = "Normalize All Vertex Groups\nNormalize all weights of all vertex groups, "
...
void OBJECT_OT_vertex_group_smooth(wmOperatorType *ot)
{
	...
	ot->description = "Smooth Vertex Weights\nSmooth weights for selected vertices";
...
void OBJECT_OT_vertex_group_clean(wmOperatorType *ot)
{
	...
	ot->description = "Clean Vertex Group\nRemove vertex group assignments which are not required";
...
void OBJECT_OT_vertex_group_quantize(wmOperatorType *ot)
{
	...
	ot->description = "Quantize Vertex Weights\nSet weights to a fixed number of steps";
...
void OBJECT_OT_vertex_group_limit_total(wmOperatorType *ot)
{
	...
	ot->description = "Limit Number of Weights per Vertex\nLimit deform weights associated with a vertex to a specified number by removing lowest weights";
...
void OBJECT_OT_vertex_group_copy_to_selected(wmOperatorType *ot)
{
	...
	ot->description = "Copy Vertex Group to Selected\nReplace vertex groups of selected objects by vertex groups of active object";
...
void OBJECT_OT_vertex_group_set_active(wmOperatorType *ot)
{
	...
	ot->description = "Set Active Vertex Group\nSet the active vertex group";
...
void OBJECT_OT_vertex_group_move(wmOperatorType *ot)
{
	...
	ot->description = "Move Vertex Group\nMove the active vertex group up/down in the list";
...
void OBJECT_OT_vertex_weight_set_active(wmOperatorType *ot)
{
	...
	ot->description = "Set Active Group\nSet as active vertex group";
...
void OBJECT_OT_vertex_weight_normalize_active_vertex(wmOperatorType *ot)
{
	...
	ot->description = "Normalize Active\nNormalize active vertex's weights";
