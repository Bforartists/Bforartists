...
#include "BLI_map.hh"
#include "BLI_math_base.hh"  // bfa node blend
                            ...
                            ui::Block &block)
{
  ...
  const float outline_width = U.pixelsize;
  bfa_node_group_outline(snode, node, rct, color_id);
  /* Header. */
  {
  ...
  /* Body. */
  {
    ...
    // bfa node color blend moved above
    // else {
                                ...
                                ui::Block &block)
{
  ...
  /* Error messages on collapsed nodes. */
  {
  ...
  ui::Button *but = uiDefBut(&block,
                             ...
                             short(BLI_rctf_size_x(&rct) -
                                   (3 * U.widget_unit)), /* BFA - increased margin for new icon */
                             NODE_DY,
                             nullptr,
                             0,
                             0,
