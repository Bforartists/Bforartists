...
DEF_ICON_COLOR(ZOOMIN)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ZOOMOUT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(PANEL_CLOSE)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(GP_SELECT_BETWEEN_STROKES)/* bfa - new iconsheet*/
DEF_ICON_COLOR(INVERSESQUARECURVE) /* bfa - new iconsheet*/
DEF_ICON_COLOR(PROP_PROJECTED) /* bfa - new iconsheet*/
...
DEF_ICON_COLOR(MOD_MESH_CACHE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ADD)/* bfa - new iconsheet*/
DEF_ICON_BLANK(218)
DEF_ICON_COLOR(ALIGN_CENTER) /* bfa - new iconsheet*/

/* ------------------------- Row 4 --------------------------*/

DEF_ICON_COLOR(LAMP)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MATERIAL)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(ALIGN_FLUSH)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ALIGN_JUSTIFY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ALIGN_LEFT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ALIGN_MIDDLE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ALIGN_RIGHT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ALIGN_BOTTOM)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ALIGN_TOP)/* bfa - new iconsheet*/
DEF_ICON_COLOR(DECORATE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(DECORATE_ANIMATE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(DECORATE_DRIVER)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(DECORATE_KEYFRAME)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ORIENTATION_CURSOR)/* bfa - new iconsheet*/
DEF_ICON_COLOR(DECORATE_OVERRIDE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(DECORATE_UNLOCKED)/* bfa - new iconsheet*/
DEF_ICON_COLOR(DECORATE_LOCKED)/* bfa - new iconsheet*/
DEF_ICON_COLOR(FACE_MAPS)/* bfa - new iconsheet*/
DEF_ICON_BLANK(330)
DEF_ICON_COLOR(FILE_NEW)/* bfa - new iconsheet*/
DEF_ICON_COLOR(FILEBROWSER) /* bfa - new iconsheet*/
...
DEF_ICON_COLOR(SCULPTMODE_HLT) /* bfa - new iconsheet*/
...
DEF_ICON_COLOR(GRAPH)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LOOP_CUT_AND_SLIDE)
DEF_ICON_COLOR(HIDE_ON)/* bfa - new iconsheet*/
DEF_ICON_COLOR(HIDE_OFF)/* bfa - new iconsheet*/
DEF_ICON_COLOR(IMAGE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(KEYFRAME_HLT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(KEYFRAME)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIBRARY_DATA_OVERRIDE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHT_AREA)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(MATERIAL_DATA)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(HANDLE_AUTO_CLAMPED)
...
DEF_ICON_COLOR(LIGHT_DATA)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHT_HEMI)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHT_POINT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHT_SPOT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHT_SUN)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHTPROBE_CUBEMAP)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHTPROBE_GRID)/* bfa - new iconsheet*/
DEF_ICON_COLOR(LIGHTPROBE_PLANAR)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(GREASEPENCIL)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(MATCLOTH)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MATFLUID)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MATSHADERBALL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(NODE_COMPOSITING)/* bfa - new iconsheet*/
DEF_ICON_COLOR(NODE_CORNER)/* bfa - new iconsheet*/
DEF_ICON_COLOR(NODE_MATERIAL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(NODE_SIDE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(NODE_TOP)/* bfa - new iconsheet*/
DEF_ICON_COLOR(NORMALS_FACE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(NORMALS_VERTEX)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(NORMALS_VERTEX_FACE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OBJECT_ORIGIN)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ONIONSKIN_OFF)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ONIONSKIN_ON)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ORIENTATION_GIMBAL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ORIENTATION_LOCAL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ORIENTATION_NORMAL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ORIENTATION_VIEW)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ORPHAN_DATA)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OUTLINER)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(OUTLINER_OB_LAMP)
...
DEF_ICON_COLOR(EMPTY_SINGLEARROW)
...
DEF_ICON_COLOR(OUTLINER_DATA_GREASEPENCIL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OUTLINER_DATA_LIGHT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OUTLINER_OB_GREASEPENCIL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OUTLINER_OB_IMAGE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OUTLINER_OB_LIGHT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OUTLINER_OB_LIGHTPROBE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OVERLAY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(PIVOT_ACTIVE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(PIVOT_BOUNDBOX)/* bfa - new iconsheet*/
DEF_ICON_COLOR(PIVOT_CURSOR)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(OUTLINER_DATA_LAMP)/* bfa - new iconsheet*/
DEF_ICON_BLANK(628)
...
DEF_ICON_COLOR(PIVOT_INDIVIDUAL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(PIVOT_MEDIAN)/* bfa - new iconsheet*/
DEF_ICON_COLOR(PRESET)/* bfa - new iconsheet*/
DEF_ICON_COLOR(PROPERTIES)/* bfa - new iconsheet*/
DEF_ICON_COLOR(REMOVE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SCULPT_DYNTOPO)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SHADERFX)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SHADING_BBOX)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SHADING_RENDERED)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SHADING_SOLID)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(LAMP_POINT)
DEF_ICON_COLOR(LAMP_SUN)
DEF_ICON_COLOR(LAMP_SPOT)
DEF_ICON_BLANK(695)
DEF_ICON_COLOR(LAMP_AREA)
...
DEF_ICON_COLOR(SHADING_TEXTURE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SHADING_WIRE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SORT_DESC)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SORT_ASC)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SYSTEM)/* bfa - new iconsheet*/
DEF_ICON_COLOR(COLLECTION_NEW)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TOOL_SETTINGS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TRACKING)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TRACKING_BACKWARDS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TRACKING_BACKWARDS_SINGLE)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(TRACKING_CLEAR_BACKWARDS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TRACKING_CLEAR_FORWARDS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TRACKING_FORWARDS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TRACKING_FORWARDS_SINGLE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TRACKING_REFINE_BACKWARDS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(TRACKING_REFINE_FORWARDS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(UNDERLINE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(USER)/* bfa - new iconsheet*/
DEF_ICON_COLOR(VIEW_CAMERA)/* bfa - new iconsheet*/
DEF_ICON_COLOR(VIEW_ORTHO)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(NODE_BRIGHT_CONTRAST)
DEF_ICON_COLOR(NODE_BUMP)
DEF_ICON_COLOR(NODE_CAMERADATA)
DEF_ICON_COLOR(NODE_CHANNEL)

DEF_ICON_COLOR(VIEW_PAN)/* bfa - new iconsheet*/
DEF_ICON_COLOR(VIEW_PERSPECTIVE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(VIEW_ZOOM)/* bfa - new iconsheet*/
DEF_ICON_COLOR(VIS_SEL_11)/* bfa - new iconsheet*/
DEF_ICON_COLOR(VIS_SEL_10)/* bfa - new iconsheet*/
DEF_ICON_COLOR(VIS_SEL_01)/* bfa - new iconsheet*/
DEF_ICON_COLOR(VIS_SEL_00)/* bfa - new iconsheet*/
DEF_ICON_COLOR(OUTLINER_DATA_GP_LAYER)/* bfa - new iconsheet*/
DEF_ICON_COLOR(WORKSPACE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(XRAY)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(CENTER_ONLY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(HOLDOUT_OFF)/* bfa - new iconsheet*/
DEF_ICON_COLOR(HOLDOUT_ON)/* bfa - new iconsheet*/
DEF_ICON_COLOR(COMMUNITY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(CONE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(CUBE)/* bfa - new iconsheet*/
DEF_ICON_BLANK(902)
DEF_ICON_COLOR(DRIVER_DISTANCE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(DRIVER_ROTATIONAL_DIFFERENCE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(DRIVER_TRANSFORM)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(NODE_COMPOSITE_OUTPUT)
...
DEF_ICON_COLOR(EMPTY_AXIS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(EMPTY_SINGLE_ARROW)/* bfa - new iconsheet*/
DEF_ICON_COLOR(EXPERIMENTAL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(FAKE_USER_OFF)/* bfa - new iconsheet*/
DEF_ICON_COLOR(FAKE_USER_ON)/* bfa - new iconsheet*/
DEF_ICON_BLANK(958)
DEF_ICON_COLOR(GP_MULTIFRAME_EDITING)/* bfa - new iconsheet*/
DEF_ICON_COLOR(GP_ONLY_SELECTED)/* bfa - new iconsheet*/
DEF_ICON_COLOR(GP_SELECT_POINTS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(GP_SELECT_STROKES)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(RIGID_BODY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(IMAGE_BACKGROUND)/* bfa - new iconsheet*/
DEF_ICON_COLOR(RIGID_BODY_CONSTRAINT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(IMAGE_REFERENCE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(INDIRECT_ONLY_OFF)/* bfa - new iconsheet*/
DEF_ICON_COLOR(INDIRECT_ONLY_ON)/* bfa - new iconsheet*/
DEF_ICON_BLANK(1016)
DEF_ICON_COLOR(MOD_HUE_SATURATION)/* bfa - new iconsheet*/
DEF_ICON_BLANK(1018)
DEF_ICON_COLOR(MOD_NOISE)

/* ------------------------- Row 18 --------------------------*/

DEF_ICON_COLOR(MODIFIER)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_WAVE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_BUILD)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_DECIM)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_MIRROR)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SOFT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SUBSURF)/* bfa - new iconsheet*/
DEF_ICON_COLOR(HOOK)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_PHYSICS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_PARTICLES)/* bfa - new iconsheet*/

DEF_ICON_COLOR(MOD_BOOLEAN)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_EDGESPLIT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_ARRAY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_UVPROJECT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_DISPLACE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_CURVE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_LATTICE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(CONSTRAINT_DATA)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_ARMATURE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SHRINKWRAP)/* bfa - new iconsheet*/

DEF_ICON_COLOR(MOD_CAST)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_MESHDEFORM)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_BEVEL)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SMOOTH)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SIMPLEDEFORM)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_MASK)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(NODE_EXITEDITGROUP)
...
DEF_ICON_COLOR(MOD_OFFSET)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_OPACITY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_PARTICLE_INSTANCE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SIMPLIFY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_THICKNESS)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_TIME)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_TINT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MODIFIER_OFF)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MODIFIER_ON)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ORIENTATION_GLOBAL)/* bfa - new iconsheet*/

/* ------------------------- Row 19 --------------------------*/

/* MODIFIERS */
DEF_ICON_COLOR(MOD_CLOTH)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_EXPLODE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_FLUIDSIM)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_MULTIRES)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SMOKE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SOLIDIFY)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SCREW)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_VERTEX_WEIGHT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_DYNAMICPAINT)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_REMESH)/* bfa - new iconsheet*/

DEF_ICON_COLOR(MOD_OCEAN)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_WARP)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_SKIN)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_TRIANGULATE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_WIREFRAME)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_DATA_TRANSFER)/* bfa - new iconsheet*/
DEF_ICON_COLOR(MOD_NORMALEDIT)/* bfa - new iconsheet*/
...
DEF_ICON_BLANK(1125)
DEF_ICON_COLOR(OUTPUT)/* bfa - new iconsheet*/
DEF_ICON_BLANK(1127)
DEF_ICON_BLANK(1128)
DEF_ICON_COLOR(SPHERE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(STROKE)/* bfa - new iconsheet*/
DEF_ICON_BLANK(1131)
DEF_ICON_COLOR(UV)
DEF_ICON_COLOR(WINDOW)/* bfa - new iconsheet*/
DEF_ICON_BLANK(1134)
...
DEF_ICON_BLANK(1230)
DEF_ICON_COLOR(NODE_MATERIALOUTPUT)
...
DEF_ICON_COLOR(SMOOTHCURVE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SPHERECURVE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(ROOTCURVE)/* bfa - new iconsheet*/
DEF_ICON_COLOR(SHARPCURVE)/* bfa - new iconsheet*/
...
DEF_ICON_COLOR(SELECT_DIFFERENCE)/*bfa - new iconset*/
DEF_ICON_COLOR(SELECT_EXTEND)/*bfa - new iconset*/
DEF_ICON_COLOR(SELECT_INTERSECT)/*bfa - new iconset*/
DEF_ICON_COLOR(SELECT_SET)/*bfa - new iconset*/
DEF_ICON_COLOR(SELECT_SUBTRACT)/*bfa - new iconset*/
DEF_ICON_COLOR(FCURVE_SNAPSHOT)/*bfa - new iconset*/
DEF_ICON_BLANK(1360)
DEF_ICON_BLANK(1361)
DEF_ICON_COLOR(OBJECT_HIDDEN)/*bfa - new iconset*/
DEF_ICON_BLANK(1363)
...
DEF_ICON_BLANK(1434)
DEF_ICON_COLOR(VIEW)  /*bfa - new iconset*/
DEF_ICON_COLOR(TILT)
DEF_ICON_COLOR(AXIS_SIDE) /*bfa - new iconset*/
DEF_ICON_COLOR(AXIS_FRONT) /*bfa - new iconset*/
DEF_ICON_COLOR(AXIS_TOP) /*bfa - new iconset*/
DEF_ICON_COLOR(NDOF_DOM)
DEF_ICON_COLOR(NDOF_TURN)
DEF_ICON_COLOR(NDOF_FLY)
DEF_ICON_COLOR(NDOF_TRANS)
...
DEF_ICON_COLOR(SEQ_RELOAD_STRIPS)
DEF_ICON_COLOR(SEQ_RELOAD_ADJUST_LENGTH)
...
DEF_ICON_COLOR(SEQ_CUT_HARD_AT_FRAME)
DEF_ICON_COLOR(SEQ_CUT_SOFT_AT_FRAME)
