...
DEF_ICON_COLOR(SEQUENCER_SWAP_STRIP_LEFT)
DEF_ICON_COLOR(SEQUENCER_SWAP_STRIP_RIGHT)
DEF_ICON_COLOR(SEQUENCER_RELOAD_STRIPS)
DEF_ICON_COLOR(SEQUENCER_RELOAD_STRIPS_AND_ADJUST_LENGTH)
DEF_ICON_BLANK(1700)
DEF_ICON_BLANK(1701)
DEF_ICON_BLANK(1702)
DEF_ICON_BLANK(1703)
...
DEF_ICON_COLOR(SEQUENCER_SNAP_STRIP_TO_FRAME)
DEF_ICON_COLOR(SEQUENCER_CLEAR_STRIP_OFFSET)
DEF_ICON_COLOR(SEQUENCER_CUT_HARD_AT_FRAME)
DEF_ICON_COLOR(SEQUENCER_CUT_SOFT_AT_FRAME)
DEF_ICON_COLOR(SEQUENCER_DEINTERLACE)
DEF_ICON_COLOR(SEQUENCER_MOVE_EXTEND_FROM_FRAME)
DEF_ICON_COLOR(SEQUENCER_SLIP_STRIP_CONTENTS)
DEF_ICON_COLOR(SEQUENCER_REMOVE_GAPS)
DEF_ICON_COLOR(SEQUENCER_INSERT_GAPS)
DEF_ICON_COLOR(SEQUENCER_SWAP_DATA)
