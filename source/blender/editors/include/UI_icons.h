...
/* BFA -  MODES ACTIVE */
DEF_ICON(OBJECTMODE__ACTIVE)
DEF_ICON(EDITMODE_ACTIVE)
DEF_ICON(FACESEL_ACTIVE)
DEF_ICON(VPAINT_ACTIVE)
DEF_ICON(TPAINT_ACTIVE)
DEF_ICON(WPAINT_ACTIVE)
DEF_ICON(SCULPTMODE_ACTIVE)
DEF_ICON(POSE_ACTIVE)
DEF_ICON(PARTICLEMODE_ACTIVE)
DEF_ICON(NOT_AVAILABLE)
