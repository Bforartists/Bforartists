...
DEF_ICON(30) /*Thanks Blender devs. Where ever this one is in use ... */
DEF_ICON(ADD)
DEF_ICON(ALEMBIC)
...
DEF_ICON(TRANSITION)
	...
	DEF_ICON(extend_0013)
	DEF_ICON(extend_0014)
	DEF_ICON(extend_0015)
...
DEF_ICON(CENTER_ONLY)
	...
	DEF_ICON(extend_0016)
	DEF_ICON(extend_0017)
