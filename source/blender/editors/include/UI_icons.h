...
DEF_ICON_COLOR(ENVIRONMENT_TEX)
...
DEF_ICON_COLOR(DUPLICATE) //bfa, duplicate icon
...
DEF_ICON_COLOR(OCEAN_TEX)
DEF_ICON_COLOR(POINT_DENSITY_TEX)
...
DEF_ICON_COLOR(REVERSE_RED)
DEF_ICON_COLOR(REVERSE_GREEN)
DEF_ICON_COLOR(REVERSE_BLUE)
...
DEF_ICON_COLOR(SET_START)
DEF_ICON_COLOR(SET_END)
...
DEF_ICON_COLOR(FILESEL) // File Browser
DEF_ICON_COLOR(IMAGE_COL) // UV Image Editor
...
DEF_ICON_COLOR(STROKE_SELECT)

DEF_ICON_COLOR(FULLSCREEN_AREA)
...
/* ------------------------- Row 6 --------------------------*/
	...
	/* MODES */
DEF_ICON_COLOR(OBJECT_DATAMODE)	// XXX fix this up
...
DEF_ICON_COLOR(LIGHTPAINT) // deprecated
...
DEF_ICON_COLOR(TRANSITION)
	...
	DEF_ICON_COLOR(extend_0013)
	DEF_ICON_COLOR(extend_0014)
	DEF_ICON_COLOR(extend_0015)
...
DEF_ICON_COLOR(REMOVE_MTEASTRIP)
DEF_ICON_COLOR(INCLUDE)
...
DEF_ICON_COLOR(MOVE_LEFT)
DEF_ICON_COLOR(MOVE_RIGHT)
...
DEF_ICON_COLOR(OUTLINER_DATA_LAMP)
...
DEF_ICON_COLOR(MAKE_SCREENCAST)
DEF_ICON_COLOR(MAKE_SCREENSHOT)
DEF_ICON_COLOR(TOGGLE_CONSOLE)
...
#ifndef DEF_ICON_BLANK_SKIP
	/* available */
	DEF_ICON_COLOR(BLANK0365)
	DEF_ICON_COLOR(BLANK0366)
	DEF_ICON_COLOR(BLANK0367)
#endif
...
DEF_ICON_COLOR(CENTER_ONLY)
	...
	DEF_ICON_COLOR(extend_0016)
	DEF_ICON_COLOR(extend_0017)
...
DEF_ICON_COLOR(CONE)
DEF_ICON_COLOR(CUBE)
DEF_ICON_COLOR(DECORATE_LIBRARY_OVERRIDE)
...
DEF_ICON_COLOR(WEIGHT_GRADIENT)
...
DEF_ICON_COLOR(REMOVE_FROM_GROUP)
...
DEF_ICON_COLOR(GREASEPENCIL_CONVERT)
...
DEF_ICON_COLOR(NODE_DIFFERENCE)
...
DEF_ICON_COLOR(SLEECT_INTERIOR)
...
DEF_ICON_COLOR(NODE_DISPLACE)
DEF_ICON_COLOR(NODE_DISTANCE)
DEF_ICON_COLOR(NODE_DISTORTEDNOISE)
...
DEF_ICON_COLOR(HEART)
DEF_ICON_COLOR(IMAGE_BACKGROUND)
DEF_ICON_COLOR(IMAGE_PLANE)
...
DEF_ICON_COLOR(NODE_FILTER)
DEF_ICON_COLOR(NODE_FLIP)
...
DEF_ICON_COLOR(SPACE2)	// XXX
DEF_ICON_COLOR(SPACE3)	// XXX
...
DEF_ICON_COLOR(UV_DATA)
	...
	DEF_ICON_COLOR(extend_195)
	DEF_ICON_COLOR(extend_196)
	DEF_ICON_COLOR(extend_197)
	DEF_ICON_COLOR(extend_198)
	DEF_ICON_COLOR(extend_199)
	DEF_ICON_COLOR(extend_200)
...
DEF_ICON_COLOR(NORMALIZE_FCURVES) /*bfa - Name in icon set: ICON_ROTATE-7*/
...
DEF_ICON_COLOR(NODE_MASK)
DEF_ICON_COLOR(NODE_MATERIALOUTPUT)
DEF_ICON_COLOR(NODE_MATH)
DEF_ICON_COLOR(NODE_MIXRGB)
DEF_ICON_COLOR(NODE_MIXSHADER)
DEF_ICON_COLOR(NODE_MOVE)
DEF_ICON_COLOR(NODE_MOVIE)
DEF_ICON_COLOR(NODE_MOVIEDISTORT)
DEF_ICON_COLOR(NODE_MUSGRAVE)

/*bfa- don't change the order of the mouse icons*/
DEF_ICON_COLOR(MOUSE_LMB)
DEF_ICON_COLOR(MOUSE_MMB)
DEF_ICON_COLOR(MOUSE_RMB)
DEF_ICON_COLOR(MOUSE_MOVE)
DEF_ICON_COLOR(MOUSE_LMB_DRAG)
DEF_ICON_COLOR(MOUSE_MMB_DRAG)
DEF_ICON_COLOR(MOUSE_RMB_DRAG)
/*bfa*/

#ifndef DEF_ICON_BLANK_SKIP

	DEF_ICON_COLOR(extend_208)
	DEF_ICON_COLOR(extend_209)
	DEF_ICON_COLOR(extend_210)
...
DEF_ICON_COLOR(PROP_OFF)
DEF_ICON_COLOR(PROP_ON)
DEF_ICON_COLOR(PROP_CON)
...
DEF_ICON_COLOR(NODE_NOISE)
DEF_ICON_COLOR(NODE_NORMAL)
...
DEF_ICON_COLOR(NODE_POINTCLOUD)
	...
	DEF_ICON_COLOR(extend_211)
	DEF_ICON_COLOR(extend_212)
	DEF_ICON_COLOR(extend_213)
	DEF_ICON_COLOR(extend_214)
	DEF_ICON_COLOR(extend_215)
	DEF_ICON_COLOR(extend_216)
	DEF_ICON_COLOR(extend_217)
	DEF_ICON_COLOR(extend_218)
	DEF_ICON_COLOR(extend_219)
	DEF_ICON_COLOR(extend_220)
...
DEF_ICON_COLOR(NODE_RENDERLAYER)
DEF_ICON_COLOR(NODE_REROUTE)
DEF_ICON_COLOR(NODE_RGB)
DEF_ICON_COLOR(NODE_RGBCURVE)
DEF_ICON_COLOR(NODE_RGBTOBW)
DEF_ICON_COLOR(NODE_ROTATE)
DEF_ICON_COLOR(NODE_SCALE)

#ifndef DEF_ICON_BLANK_SKIP

	DEF_ICON_COLOR(extend_221)
	DEF_ICON_COLOR(extend_222)
	DEF_ICON_COLOR(extend_223)
	DEF_ICON_COLOR(extend_224)
	DEF_ICON_COLOR(extend_225)
	DEF_ICON_COLOR(extend_226)
	DEF_ICON_COLOR(extend_227)
	DEF_ICON_COLOR(extend_228)
	DEF_ICON_COLOR(extend_229)
	DEF_ICON_COLOR(extend_230)
...
DEF_ICON_COLOR(LAPLACIAN_SMOOTH_VERTEX)
// ----------------
DEF_ICON_COLOR(SNAP_SURFACE)
DEF_ICON_COLOR(AUTOMERGE_ON)
DEF_ICON_COLOR(AUTOMERGE_OFF)
...
DEF_ICON_COLOR(EXTRUDE_INDIVIDUAL)
...
DEF_ICON_COLOR(NODE_STUCCI)

#ifndef DEF_ICON_BLANK_SKIP

	DEF_ICON_COLOR(extend_231)
	DEF_ICON_COLOR(extend_232)
	DEF_ICON_COLOR(extend_233)
	DEF_ICON_COLOR(extend_234)
	DEF_ICON_COLOR(extend_235)
	DEF_ICON_COLOR(extend_236)
	DEF_ICON_COLOR(extend_237)
	DEF_ICON_COLOR(extend_238)
	DEF_ICON_COLOR(extend_239)
	DEF_ICON_COLOR(extend_240)
...
// -----------
DEF_ICON_COLOR(LOCKVIEW_OFF)
DEF_ICON_COLOR(LOCKVIEW_ON)
...
DEF_ICON_COLOR(NODE_SWITCH)
DEF_ICON_COLOR(NODE_SWITCHVIEW)
DEF_ICON_COLOR(NODE_TANGENT)
DEF_ICON_COLOR(NODE_TEXCOORDINATE)
DEF_ICON_COLOR(NODE_TEXTURE)
DEF_ICON_COLOR(NODE_TIME)
...
DEF_ICON_COLOR(NODE_TRACKPOSITION)
	...
	DEF_ICON_COLOR(extend_241)
	DEF_ICON_COLOR(extend_242)
	DEF_ICON_COLOR(extend_243)
	DEF_ICON_COLOR(extend_244)
	DEF_ICON_COLOR(extend_245)
	DEF_ICON_COLOR(extend_246)
	DEF_ICON_COLOR(extend_247)
	DEF_ICON_COLOR(extend_248)
	DEF_ICON_COLOR(extend_249)
	DEF_ICON_COLOR(extend_250)
...
DEF_ICON_COLOR(LOAD_ABC) // alembic
DEF_ICON_COLOR(SAVE_ABC) // alembic
...
DEF_ICON_COLOR(NODE_VECTOR_TRANSFORM)
	...
	DEF_ICON_COLOR(extend_251)
	DEF_ICON_COLOR(extend_252)
	DEF_ICON_COLOR(extend_253)
	DEF_ICON_COLOR(extend_254)
	DEF_ICON_COLOR(extend_255)
	DEF_ICON_COLOR(extend_256)
	DEF_ICON_COLOR(extend_257)
	DEF_ICON_COLOR(extend_258)
	DEF_ICON_COLOR(extend_259)
	DEF_ICON_COLOR(extend_260)
...
DEF_ICON_COLOR(NODE_WIREFRAME)
	...
	DEF_ICON_COLOR(extend_261)
	DEF_ICON_COLOR(extend_262)
	DEF_ICON_COLOR(extend_263)
	DEF_ICON_COLOR(extend_264)
	DEF_ICON_COLOR(extend_265)
	DEF_ICON_COLOR(extend_266)
	DEF_ICON_COLOR(extend_267)
	DEF_ICON_COLOR(extend_268)
	DEF_ICON_COLOR(extend_269)
	DEF_ICON_COLOR(extend_270)
...
DEF_ICON_COLOR(NODE_WOOD)
DEF_ICON_COLOR(NODE_WORLDOUTPUT)
DEF_ICON_COLOR(NODE_ZCOMBINE)
DEF_ICON_COLOR(NODE_KEYING)
DEF_ICON_COLOR(NODE_LAMP)
DEF_ICON_COLOR(NODE_MARBLE)
...
DEF_ICON_COLOR(SET_FRAMES)
	...
	DEF_ICON_COLOR(extend_271)
	DEF_ICON_COLOR(extend_272)
	DEF_ICON_COLOR(extend_273)
	DEF_ICON_COLOR(extend_274)
	DEF_ICON_COLOR(extend_275)
	DEF_ICON_COLOR(extend_276)
	DEF_ICON_COLOR(extend_277)
	DEF_ICON_COLOR(extend_278)
	DEF_ICON_COLOR(extend_279)
	DEF_ICON_COLOR(extend_480)
...
DEF_ICON_COLOR(SCRIPTPLUGINS)		// XXX CREATE NEW
...
DEF_ICON_COLOR(PLANETRACK)
	...
	DEF_ICON_COLOR(extend_281)
	DEF_ICON_COLOR(extend_282)
	DEF_ICON_COLOR(extend_283)
	DEF_ICON_COLOR(extend_284)
	DEF_ICON_COLOR(extend_285)
	DEF_ICON_COLOR(extend_286)
	DEF_ICON_COLOR(extend_487)
	DEF_ICON_COLOR(extend_488)
	DEF_ICON_COLOR(extend_489)
	DEF_ICON_COLOR(extend_490)
	...
	DEF_ICON_COLOR(IMAGE_RGB)	// XXX CHANGE TO STRAIGHT ALPHA, Z ETC
	...
	DEF_ICON_COLOR(extend_291)
	DEF_ICON_COLOR(extend_292)
	DEF_ICON_COLOR(extend_293)
	DEF_ICON_COLOR(extend_294)
	DEF_ICON_COLOR(extend_295)
	DEF_ICON_COLOR(extend_296)
	DEF_ICON_COLOR(extend_297)
	DEF_ICON_COLOR(extend_298)
	DEF_ICON_COLOR(extend_299)
	DEF_ICON_COLOR(extend_300)
