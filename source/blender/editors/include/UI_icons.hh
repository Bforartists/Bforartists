...
DEF_ICON_COLOR(ACTION_REPLACE)
DEF_ICON_COLOR(ACTION_REPLACE_NEW)
DEF_ICON_COLOR(ACTION_REPLACE_DUPLICATE)
...
DEF_ICON_COLOR(ALIGN_X)
DEF_ICON_COLOR(ALIGN_Y)
...
DEF_ICON_COLOR(COLLECTION_CHILDREN)
...
DEF_ICON_COLOR(CURVES_DATA)
DEF_ICON_COLOR(CURVES_SCULPT_ADD)
DEF_ICON_COLOR(CURVES_SCULPT_DELETE)
DEF_ICON_COLOR(CURVES_SCULPT_DENSITY)
...
/*BFA - Don't change the order of these two*/
...
DEF_ICON_COLOR(DOWNLOAD)
DEF_ICON_COLOR(DOWNLOAD_DONE)
...
DEF_ICON_COLOR(FILTER_OFF)
DEF_ICON_COLOR(FIXED_SIZE)
DEF_ICON_COLOR(FLATTEN)
...
DEF_ICON_COLOR(GOAL)
DEF_ICON_COLOR(GOTO)
DEF_ICON_COLOR(GP_BOTH)
DEF_ICON_COLOR(GP_CAPS_FLAT)
DEF_ICON_COLOR(GP_CAPS_ROUND)
DEF_ICON_COLOR(GP_CAPS_SHARP)
DEF_ICON_COLOR(GP_CYCLIC_STROKE)
DEF_ICON_COLOR(GP_DELETE_FILL)
DEF_ICON_COLOR(GP_DELETE_POINT)
DEF_ICON_COLOR(GP_DELETE_STROKE)
DEF_ICON_COLOR(GP_DRAW_STROKE)
DEF_ICON_COLOR(GP_DRAW_FILL)
DEF_ICON_COLOR(GP_DRAW_BOTH)
DEF_ICON_COLOR(GP_FILL)
DEF_ICON_COLOR(GP_FILL_JOIN)
DEF_ICON_COLOR(GP_FILL_SELECT)
DEF_ICON_COLOR(GP_FILL_SEPARATE)
DEF_ICON_COLOR(GP_MULTIFRAME_EDITING)
DEF_ICON_COLOR(GP_ONLY_SELECTED)
DEF_ICON_COLOR(GP_OPACITY)
...
DEF_ICON_COLOR(GRIP)
DEF_ICON_COLOR(GRIP_CORNER_BOTTOM_RIGHT)
...
DEF_ICON_COLOR(IMPLICIT_CONVERSION)
DEF_ICON_COLOR(IMPORT)
DEF_ICON_COLOR(IMPORT_EXPORT)
...
DEF_ICON_COLOR(LIBRARY_REFRESH)
...
DEF_ICON_COLOR(LINKED_DESELECT)
DEF_ICON_COLOR(LINKED_PICK)
...
DEF_ICON_COLOR(MESH_QUADSPHERE)
...
DEF_ICON_COLOR(MOD_SOUND_PITCH)
DEF_ICON_COLOR(MOD_SOUND_ECHO)
...
DEF_ICON_COLOR(NODE_BUNDLE_GET)
DEF_ICON_COLOR(NODE_BUNDLE_GET_ITEM)
DEF_ICON_COLOR(NODE_BUNDLE_JOIN)
DEF_ICON_COLOR(NODE_BUNDLE_SEPARATE)
DEF_ICON_COLOR(NODE_BUNDLE_SET)
DEF_ICON_COLOR(NODE_BUNDLE_STORE_ITEM)
DEF_ICON_COLOR(NODE_CHANNEL)
DEF_ICON_COLOR(NODE_CHECKER)
DEF_ICON_COLOR(NODE_CHROMA)
DEF_ICON_COLOR(NODE_CLAMP)
DEF_ICON_COLOR(NODE_CLUSTERBYCONNECTED)
DEF_ICON_COLOR(NODE_CLUSTERBYDISTANCE)
DEF_ICON_COLOR(NODE_CLOUDS)
DEF_ICON_COLOR(NODE_CLOSURE)
DEF_ICON_COLOR(NODE_CLOSURETOLIST)
...
DEF_ICON_COLOR(NODE_DEACTIVATE_VOXEL)
...
DEF_ICON_COLOR(NODE_FIELDATINDEX)
DEF_ICON_COLOR(NODE_FIELDTOGRID)
DEF_ICON_COLOR(NODE_FIELDTOLIST)
DEF_ICON_COLOR(NODE_FILTERLIST)
...
DEF_ICON_COLOR(NODE_GETGEOMETRYCOMPONENT)
...
DEF_ICON_COLOR(NODE_GP_COLOR)
DEF_ICON_COLOR(NODE_GP_DRAWTIME)
DEF_ICON_COLOR(NODE_GP_FILLID)
DEF_ICON_COLOR(NODE_GP_SETCOLOR)
DEF_ICON_COLOR(NODE_GP_STROKESOFTNESS)
DEF_ICON_COLOR(NODE_GP_STROKEVISIBILITY)
DEF_ICON_COLOR(NODE_GROUPINSERT)
DEF_ICON_COLOR(NODE_GRIDCURL)
DEF_ICON_COLOR(NODE_GRIDDIVERGENCE)
DEF_ICON_COLOR(NODE_GRIDERODE)
DEF_ICON_COLOR(NODE_GRIDGRADIENT)
DEF_ICON_COLOR(NODE_GRIDLAPLACIAN)
DEF_ICON_COLOR(NODE_GRIDMEAN)
DEF_ICON_COLOR(NODE_GRIDMEDIAN)
DEF_ICON_COLOR(NODE_GRIDTOMESH)
DEF_ICON_COLOR(NODE_GRIDTOPLOGYBOOLEAN)
...
DEF_ICON_COLOR(NODE_INSTANCEREFERENCE)
...
DEF_ICON_COLOR(NODE_LISTLENGTH)
...
DEF_ICON_COLOR(NODE_NURBS_ORDER)
DEF_ICON_COLOR(NODE_NURBS_WEIGHT)
...
DEF_ICON_COLOR(OUTLINER_DATA_CURVES)
...
DEF_ICON_COLOR(PAINT_DRAW_LINE)
DEF_ICON_COLOR(PAINT_DRAW_POLY)
...
DEF_ICON_COLOR(RENDER_SWAP_DIMENSIONS)
...
DEF_ICON_COLOR(SELECT_SHORTESTPATHPICK)
DEF_ICON_COLOR(SELECT_SIDEOFACTIVE)
DEF_ICON_COLOR(SELECT_SUBTRACT)
DEF_ICON_COLOR(SELECT_TILE)
...
DEF_ICON_COLOR(SEQ_STRIP)
DEF_ICON_COLOR(SEQ_STRIP_DATA)
...
DEF_ICON_COLOR(SPACE_LOOPS_EVENLY)
...
DEF_ICON_COLOR(STATUS_ERROR)
DEF_ICON_COLOR(STATUS_ERROR_FILLED)
DEF_ICON_COLOR(STATUS_INFO)
DEF_ICON_COLOR(STATUS_INFO_FILLED)
DEF_ICON_COLOR(STATUS_WARNING)
DEF_ICON_COLOR(STATUS_WARNING_FILLED)
...
DEF_ICON_COLOR(STRING_TO_IMAGE)
