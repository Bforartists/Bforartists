                                                   ...
                                                   const wmEvent * /*event*/)
{
  ...
  PointerRNA op_ptr = row_offset->op("ARMATURE_OT_parent_set", IFACE_("Keep Offset"), ICON_PARENT_SET); /*BFA icon*/
  RNA_enum_set(&op_ptr, "type", ARM_PAR_OFFSET);

  uiLayout *row_connect = &layout->row(false);
  row_connect->enabled_set(enable_connect);
  op_ptr = row_connect->op("ARMATURE_OT_parent_set", IFACE_("Connected"), ICON_PARENT_BONE); /*BFA icon*/
                                                     ...
                                                     const wmEvent * /*event*/)
{
  ...
  PointerRNA op_ptr = row_clear->op("ARMATURE_OT_parent_clear", IFACE_("Clear Parent"), ICON_CLEAR); /*BFA icon*/
  ...
  op_ptr = row_disconnect->op("ARMATURE_OT_parent_clear", IFACE_("Disconnect Bone"), ICON_PARENT_CLEAR); /*BFA icon*/
