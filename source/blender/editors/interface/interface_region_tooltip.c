...
{
  /*uiStringInfo but_label = {BUT_GET_LABEL, NULL};*/ // bfa - turned off the automated display of label in title. Not consistent.
  ...
  UI_but_string_info_get(C,
                         but,
                         /*&but_label,*/ // bfa - turned off the automated display of label in title. Not consistent.
                         &but_tip,
                         &enum_label,
                         &enum_tip,
                         &op_keymap,
  ...
  // bfa - turned off the automated display of label in title. Not consistent.
  ...
  /* Free strinfo's... */
  //if (but_label.strinfo) {  // bfa - turned off the automated display of label in title. Not consistent.
