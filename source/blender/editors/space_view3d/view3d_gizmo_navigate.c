...
static void WIDGETGROUP_navigate_draw_prepare(const bContext *C, wmGizmoGroup *gzgroup)
{
  ...
  const float co[2] = {
      rect_visible->xmax - icon_offset_from_axis,/* bfa- changed back navigation buttons to horizontal*/
      rect_visible->ymax - icon_offset_mini * 0.75f,/* bfa- changed back navigation buttons to horizontal*/
  };
