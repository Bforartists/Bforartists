    ...
    const bContext *C, ui::Layout *layout, View3D *v3d, Object *ob, float lim)
{
  ...
  ui::Block *subblock;   /* bfa - helper block for UI */
    ...
    for (i = 0, dg = static_cast<bDeformGroup *>(defbase->first); dg; i++, dg = dg->next) {
      ...
      if (vgroup_validmap[i]) {
        ...
        if (dw) {
          ...
          /* bfa - middle align text by commenting out button_drawflag_enable(but,
           * ui::BUT_TEXT_RIGHT); */
...
static void v3d_transform_butsR(ui::Layout &layout, PointerRNA *ptr)
{
  ...
  switch (RNA_enum_get(ptr, "rotation_mode")) {
    case ROT_MODE_QUAT: /* quaternion */
      ...
      sub->emboss_set(ui::EmbossType::NoneOrStatus);
    ...
    case ROT_MODE_AXISANGLE: /* axis angle */
      ...
      sub->prop(ptr,
                ...
                "",
                ICON_DECORATE_UNLOCKED);
      sub->emboss_set(ui::EmbossType::Undefined); /* bfa */
      break;
    ...
    default: /* euler rotations */
      ...
      row->emboss_set(ui::EmbossType::NoneOrStatus);
      row->prop(ptr,
                "lock_rotation",
                ui::ITEM_R_TOGGLE | ui::ITEM_R_ICON_ONLY,
                "",
                ICON_DECORATE_UNLOCKED);
      row->emboss_set(ui::EmbossType::Undefined); /* bfa */
      break;
  }
