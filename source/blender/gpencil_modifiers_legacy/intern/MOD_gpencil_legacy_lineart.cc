...
static void options_panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  // uiItemR(col, ptr, "use_crease_on_smooth", UI_ITEM_NONE, IFACE_("Crease On Smooth"),
  // ICON_NONE); uiItemR(col, ptr, "use_crease_on_sharp", UI_ITEM_NONE, IFACE_("Crease On Sharp"),
  // ICON_NONE); uiItemR(col,
  //         ptr,
  ...
  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_object_instances", UI_ITEM_NONE, NULL, ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_object_instances", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_clip_plane_boundaries", UI_ITEM_NONE, NULL, ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_clip_plane_boundaries", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_crease_on_smooth", UI_ITEM_NONE, IFACE_("Crease On Smooth"), ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_crease_on_smooth", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_crease_on_sharp", UI_ITEM_NONE, IFACE_("Crease On Sharp"), ICON_NONE);
...
static void occlusion_panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_multiple_levels", UI_ITEM_NONE, IFACE_("Range"), ICON_NONE);
...
static void material_mask_panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  /*------------------- bfa - original props */
  // uiItemR(layout, ptr, "use_material_mask_match", UI_ITEM_NONE, IFACE_("Exact Match"),
  // ICON_NONE);

  col = uiLayoutColumn(layout, true);
  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_material_mask_match", UI_ITEM_NONE, IFACE_("Exact Match"), ICON_NONE);
...
static void intersection_panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  /*------------------- bfa - original props */
  // uiItemR(layout, ptr, "use_intersection_match", UI_ITEM_NONE, IFACE_("Exact Match"),
  // ICON_NONE);
  col = uiLayoutColumn(layout, true);
  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_intersection_match", UI_ITEM_NONE, IFACE_("Exact Match"), ICON_NONE);
...
static void face_mark_panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  col = uiLayoutColumn(layout, true);
  row = uiLayoutRow(col, true);
  uiItemR(row, ptr, "use_face_mark_invert", UI_ITEM_NONE, nullptr, ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_face_mark_invert", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiItemR(row, ptr, "use_face_mark_boundaries", UI_ITEM_NONE, nullptr, ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_face_mark_boundaries", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiItemR(row, ptr, "use_face_mark_keep_contour", UI_ITEM_NONE, nullptr, ICON_NONE);
...
static void chaining_panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  // uiItemR(
  //     col, ptr, "use_loose_as_contour", UI_ITEM_NONE, IFACE_("Loose Edges As Contour"),
  //     ICON_NONE);
  // uiItemR(col, ptr, "use_detail_preserve", UI_ITEM_NONE, nullptr, ICON_NONE);
  // uiItemR(col, ptr, "use_geometry_space_chain", UI_ITEM_NONE, IFACE_("Geometry Space"),
  // ICON_NONE);
  ...
  row = uiLayoutRow(col, true);
  uiItemS(row);
  uiItemR(row, ptr, "use_fuzzy_intersections", UI_ITEM_NONE, nullptr, ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_fuzzy_intersections", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiItemS(row);
  uiItemR(row, ptr, "use_fuzzy_all", UI_ITEM_NONE, nullptr, ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_fuzzy_all", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiItemS(row);
  uiItemR(row, ptr, "use_loose_edge_chain", UI_ITEM_NONE, IFACE_("Loose Edges"), ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_loose_edge_chain", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiItemS(row);
  uiItemR(
      row, ptr, "use_loose_as_contour", UI_ITEM_NONE, IFACE_("Loose Edges As Contour"), ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_loose_as_contour", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiItemS(row);
  uiItemR(row, ptr, "use_detail_preserve", UI_ITEM_NONE, nullptr, ICON_NONE);
  uiItemDecoratorR(row, ptr, "use_detail_preserve", 0); /*bfa - decorator*/

  row = uiLayoutRow(col, true);
  uiItemS(row);
  uiItemR(row, ptr, "use_geometry_space_chain", UI_ITEM_NONE, IFACE_("Geometry Space"), ICON_NONE);
...
static void vgroup_panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_output_vertex_group_match_by_name", UI_ITEM_NONE, nullptr, ICON_NONE);
...
static void composition_panel_draw(const bContext * /*C*/, Panel *panel)
{
  ...
  row = uiLayoutRow(col, true);
  uiLayoutSetPropSep(row, false); /* bfa - use_property_split = False */
  uiItemR(row, ptr, "use_image_boundary_trimming", UI_ITEM_NONE, nullptr, ICON_NONE);
