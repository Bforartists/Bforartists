...
static void wm_block_file_close_cancel_button(uiBlock *block, wmGenericCallback *post_action)
{
  uiBut *but = uiDefIconTextBut(
      block, UI_BTYPE_BUT, 0, 0, IFACE_("Cancel"), 0, 0, 0, UI_UNIT_Y * 1.5, 0, 0, 0, 0, 0, ""); /* bfa - made the buttons higher. UI_UNIT_Y * 1.5 */
...
{
  uiBut *but = uiDefIconTextBut(
      block, UI_BTYPE_BUT, 0, 0, IFACE_("Don't Save"), 0, 0, 0, UI_UNIT_Y * 1.5, 0, 0, 0, 0, 0, ""); /* bfa - made the buttons higher. UI_UNIT_Y * 1.5 */
...
{
  uiBut *but = uiDefIconTextBut(
      block, UI_BTYPE_BUT, 0, 0, IFACE_("Save"), 0, 0, 0, UI_UNIT_Y * 1.5, 0, 0, 0, 0, 0, ""); /* bfa - made the buttons higher. UI_UNIT_Y * 1.5 */
