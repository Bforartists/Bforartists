...
static ui::Block *wm_block_create_redo(bContext *C, ARegion *region, void *arg_op)
{
  ...
  /* BFA - align operator properties to left in redo panel (ui::BUT_LABEL_ALIGN_SPLIT_COLUMN) */
  uiTemplateOperatorPropertyButs(C, &col, op, ui::BUT_LABEL_ALIGN_SPLIT_COLUMN, ui::TEMPLATE_OP_PROPS_SHOW_TITLE);
