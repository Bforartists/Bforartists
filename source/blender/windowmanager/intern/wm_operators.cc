...
static blender::ui::Block *wm_block_create_redo(bContext *C, ARegion *region, void *arg_op)
{
  ...
  /* BFA - align operator properties to left in redo panel (blender::ui::BUT_LABEL_ALIGN_SPLIT_COLUMN) */
  uiTemplateOperatorPropertyButs(C, &col, op, blender::ui::BUT_LABEL_ALIGN_SPLIT_COLUMN, blender::ui::TEMPLATE_OP_PROPS_SHOW_TITLE);
