...
if(CMAKE_C_COMPILER_ID MATCHES "Clang")
  ...
  if(WITH_BLENDER)
    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.28.29921) # MSVC 2019 16.9.16
      message(FATAL_ERROR "Compiler is unsupported, MSVC 2019 16.9.16 or newer is required for building bforartists.")
    endif()
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 19.36.32532 AND # MSVC 2022 17.6.0 has a bad codegen
      ...
      message(FATAL_ERROR "Compiler is unsupported, MSVC 2022 17.6.x has codegen issues and cannot be used to build bforartists. Please upgrade to 17.7 or newer.")
    endif()
  endif()
endif()
...
if(NOT DEFINED LIBDIR)
  ...
  if(CMAKE_CL_64)
    ...
    message(FATAL_ERROR "32 bit compiler detected, bforartists no longer provides pre-build libraries for 32 bit windows, please set the LIBDIR cmake variable to your own library folder")
  endif()
  if(MSVC_CLANG)
...
if(NOT EXISTS "${LIBDIR}/.git")
  message(FATAL_ERROR "\n\nWindows requires pre-compiled libs at: '${LIBDIR}'. Please run `make update` in the bforartists source folder to obtain them.")
endif()
