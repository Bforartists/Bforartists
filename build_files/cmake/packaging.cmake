...
if(WIN32)
  set(CPACK_PACKAGE_INSTALL_DIRECTORY "Bforartists/Bforartists ${MAJOR_VERSION}.${MINOR_VERSION}.${PATCH_VERSION}")
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "Bforartists/Bforartists ${MAJOR_VERSION}.${MINOR_VERSION}.${PATCH_VERSION}")
  ...
  set(BLENDER_NAMESPACE_GUID "82599BED-DF86-434C-85E0-3BBEA578A0CB")
...
set(CPACK_PACKAGE_EXECUTABLES "bforartists" "Bforartists ${MAJOR_VERSION}.${MINOR_VERSION}.${PATCH_VERSION}")
set(CPACK_CREATE_DESKTOP_LINKS "bforartists" "Bforartists ${MAJOR_VERSION}.${MINOR_VERSION}.${PATCH_VERSION}")
