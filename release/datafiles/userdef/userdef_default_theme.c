...
const bTheme U_theme_default = {
	...
	.tui = {
		...
		.xaxis = RGBA(0xdc0000ff),
		.yaxis = RGBA(0x00dc00ff),
		.zaxis = RGBA(0x0000dcff),
	...
	.space_view3d = {
		.back = RGBA(0x66666600),
		.back_grad = RGBA(0x40404000),
		.show_back_grad = 1,
		.title = RGBA(0xffffff00),
		.text = RGBA(0xffffff00),
		.text_hi = RGBA(0xffffff00),
		.header = RGBA(0x33333300),
		.header_text = RGBA(0xffffff00),
		.header_text_hi = RGBA(0xffffff00),
		.tab_active = RGBA(0x4d6b9900),
		.tab_inactive = RGBA(0x33333300),
		.tab_back = RGBA(0x333333cc),
		.button = RGBA(0x40404000),
		.button_title = RGBA(0xcccccc00),
		...
		.select = RGBA(0xf1580000),
		.lamp = RGBA(0x00000028),
		.active = RGBA(0xffaa4000),
		.transform = RGBA(0xffffff00),
		.vertex_select = RGBA(0xff850000),
		.vertex_bevel = RGBA(0x00a5ff00),
		.edge_select = RGBA(0xffa00000),
		.edge_seam = RGBA(0xdb251200),
		.edge_sharp = RGBA(0xff202000),
		.edge_facesel = RGBA(0x4b4b4b00),
		.edge_crease = RGBA(0xcc009900),
		.edge_bevel = RGBA(0x00a5ff00),
		.face = RGBA(0x00000012),
		.face_select = RGBA(0xff85003c),
		.face_dot = RGBA(0xff850000),
		.extra_edge_len = RGBA(0x20000000),
		.extra_edge_angle = RGBA(0x20200000),
		.extra_face_angle = RGBA(0x00200000),
		.extra_face_area = RGBA(0x00008000),
		.normal = RGBA(0x22dddd00),
		.vertex_normal = RGBA(0x2361dd00),
		.loop_normal = RGBA(0xdd23dd00),
		.bone_solid = RGBA(0xc8c8c800),
		.bone_pose = RGBA(0x50c8ff00),
		.bone_pose_active = RGBA(0x8cffff00),
		.cframe = RGBA(0x60c04000),
		.time_keyframe = RGBA(0xddd70000),
		.time_gp_keyframe = RGBA(0xb5e61d00),
		.freestyle_edge_mark = RGBA(0x7fff7f00),
		.freestyle_face_mark = RGBA(0x7fff7f33),
		.nurb_uline = RGBA(0x90900000),
		.nurb_vline = RGBA(0x80306000),
		.act_spline = RGBA(0xdb251200),
		.nurb_sel_uline = RGBA(0xf0ff4000),
		.nurb_sel_vline = RGBA(0xf090a000),
		.lastsel_point = RGBA(0xffffff00),
		.handle_auto = RGBA(0x90900000),
		.handle_vect = RGBA(0x40903000),
		.handle_align = RGBA(0x80306000),
		.handle_sel_auto = RGBA(0xf0ff4000),
		.handle_sel_vect = RGBA(0x40c03000),
		.handle_sel_align = RGBA(0xf090a000),
		.vertex_size = 6,
		.outline_width = 1,
		.facedot_size = 2,
		.editmesh_active = RGBA(0xffffff80),
		.clipping_border_3d = RGBA(0x313131ff),
		.bundle_solid = RGBA(0xc8c8c800),
		.gp_vertex_size = 3,
		.gp_vertex_select = RGBA(0xff850000),
		.skin_root = RGBA(0xb44d4d00),
	...
	.space_info = {
		...
		.info_error = RGBA(0xdc0000ff),
		.info_error_text = RGBA(0x000000ff),
		.info_warning = RGBA(0xdc8060ff),
		.info_warning_text = RGBA(0x000000ff),
		.info_info = RGBA(0x00aa00ff),
	...
	.space_outliner = {
		...
		.selected_highlight = RGBA(0x82878c4c),
	},
	.space_node = {
		.back = RGBA(0x4d4d4d00),
		.title = RGBA(0xffffffff),
		...
		.console_output = RGBA(0xdfca35ff),
		.vertex_size = 3,
		.outline_width = 1,
		.facedot_size = 4,
		.noodle_curving = 5,
		.syntaxl = RGBA(0x9b9b9ba0),
		.syntaxs = RGBA(0x977474ff),
		.syntaxb = RGBA(0x6f6a64ff),
		.syntaxn = RGBA(0x646464ff),
		.syntaxv = RGBA(0x686a75ff),
		.syntaxc = RGBA(0x69756eff),
		.syntaxd = RGBA(0x749797ff),
		.syntaxr = RGBA(0x737373ff),
		.nodeclass_output = RGBA(0x646464ff),
		.nodeclass_filter = RGBA(0x6f6a64ff),
		.nodeclass_vector = RGBA(0x6f6a64ff),
		.nodeclass_texture = RGBA(0x6f6a64ff),
		.nodeclass_shader = RGBA(0x6f6a64ff),
		.nodeclass_script = RGBA(0x6f6a64ff),
		.nodeclass_pattern = RGBA(0x6f6a64ff),
	...
	.space_toolbar = {
		...
		.extra_edge_angle = RGBA(0x202000ff),
		.extra_face_angle = RGBA(0x002000ff),
		.extra_face_area = RGBA(0x000080ff),
