...
[("Pose",
 ...
 ("Object Non-modal",
  ...
  {"items":
   [("wm.call_menu_pie",
    ...
    ("object.mode_set", {"type": 'ONE', "value": 'PRESS', "shift": True}, None),
    ("object.mode_set",
 ...
 ("3D View",
  ...
  {"items":
   [("view.reset_3d_view", {"type": 'NUMPAD_ASTERIX', "value": 'PRESS'}, None),
    ...
    ("view.reset_3d_view", {"type": 'NUMPAD_ASTERIX', "value": 'PRESS'}, None),
    ("view.reset_3d_view", {"type": 'NUMPAD_ASTERIX', "value": 'PRESS'}, None),
    ("view3d.cursor3d", {"type": 'RIGHTMOUSE', "value": 'CLICK', "alt": True}, None),
    ("transform.translate",
     {"type": 'EVT_TWEAK_R', "value": 'ANY', "shift": True},
     {"properties":
      [("cursor_transform", True),
 ...
 ("Animation",
  {"space_type": 'EMPTY', "region_type": 'WINDOW'},
  {"items":
   [("anim.change_frame", {"type": 'EVT_TWEAK_L', "value": 'EAST'}, None),
    ("anim.change_frame", {"type": 'EVT_TWEAK_L', "value": 'WEST'}, None),
    ("anim.change_frame", {"type": 'LEFTMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ],
   },
  ),
 ("Graph Editor",
  ...
  {"items":
   [("graph.clickselect",
    ...
    ("graph.cursor_set", {"type": 'EVT_TWEAK_L', "value": 'EAST'}, None),
    ("graph.cursor_set", {"type": 'EVT_TWEAK_L', "value": 'WEST'}, None),
    ("transform.transform", {"type": 'EVT_TWEAK_L', "value": 'NORTH'}, None),
    ("transform.transform", {"type": 'EVT_TWEAK_L', "value": 'NORTH_EAST'}, None),
    ("transform.transform",
    ...
    ("transform.transform",
     {"type": 'EVT_TWEAK_L', "value": 'SOUTH_WEST'},
     {"properties":
      [("mode", 'TRANSLATION'),
       ],
      },
    ...
    ("transform.transform",
     {"type": 'EVT_TWEAK_L', "value": 'NORTH_WEST'},
     {"properties":
      [("mode", 'TRANSLATION'),
       ],
      },
     ),
    ("graph.cursor_set", {"type": 'LEFTMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ],
   },
  ),
 ("Dopesheet",
 ...
 ("Clip Editor",
  ...
  {"items":
   [("clip.view_pan", {"type": 'MIDDLEMOUSE', "value": 'PRESS'}, None),
    ...
    ("clip.change_frame", {"type": 'EVT_TWEAK_L', "value": 'ANY'}, None),
    ("clip.select",
     {"type": 'LEFTMOUSE', "value": 'PRESS'},
     {"properties":
      [("extend", False),
 ...
 ("Clip Graph Editor",
  {"space_type": 'CLIP_EDITOR', "region_type": 'WINDOW'},
  {"items":
   [("clip.change_frame", {"type": 'EVT_TWEAK_L', "value": 'EAST'}, None),
    ("clip.graph_select",
     {"type": 'LEFTMOUSE', "value": 'PRESS'},
     {"properties":
      [("extend", False),
    ...
    ("transform.translate", {"type": 'W', "value": 'PRESS'}, None),
    ("transform.translate", {"type": 'EVT_TWEAK_L', "value": 'NORTH'}, None),
    ("transform.resize", {"type": 'R', "value": 'PRESS'}, None),
    ("transform.rotate", {"type": 'E', "value": 'PRESS'}, None),
    ("clip.graph_select_all_markers",
     {"type": 'LEFTMOUSE', "value": 'DOUBLE_CLICK'},
    ...
    ("clip.change_frame", {"type": 'EVT_TWEAK_L', "value": 'WEST'}, None),
    ("transform.translate", {"type": 'EVT_TWEAK_L', "value": 'SOUTH'}, None),
    ],
   },
  ),
 ("Lattice",
  ...
  {"items":
   [("wm.call_menu_pie",
    ...
    ("wm.call_menu_pie",
     ...
     {"properties":
      [("name", 'CLIP_PIE_reconstruction_pie'),
       ],
      },
     ),
    ("wm.call_menu_pie",
