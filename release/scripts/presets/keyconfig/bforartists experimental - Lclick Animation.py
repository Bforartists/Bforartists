...
[("Window",
 ...
 ("Animation",
  {"space_type": 'EMPTY', "region_type": 'WINDOW'},
  {"items":
   [("anim.change_frame", {"type": 'EVT_TWEAK_L', "value": 'ANY'}, None),
    ],
   },
  ),
 ("UV Editor",
 ...
 ("Graph Editor",
  ...
  {"items":
   [("graph.clickselect",
    ...
    ("graph.select_all", {"type": 'LEFTMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ("graph.cursor_set", {"type": 'EVT_TWEAK_L', "value": 'WEST'}, None),
    ("transform.translate", {"type": 'EVT_TWEAK_L', "value": 'SOUTH'}, None),
    ("transform.translate", {"type": 'EVT_TWEAK_L', "value": 'NORTH_EAST'}, None),
    ("transform.translate", {"type": 'EVT_TWEAK_L', "value": 'NORTH_WEST'}, None),
    ("transform.translate", {"type": 'EVT_TWEAK_L', "value": 'SOUTH_EAST'}, None),
    ("none", {"type": 'EVT_TWEAK_L', "value": 'SOUTH_WEST'}, None),
    ],
   },
  ),
 ("Dopesheet",
  ...
  {"items":
   [("action.clickselect",
    ...
    ("action.select_all", {"type": 'LEFTMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ],
   },
  ),
 ("NLA Editor",
  ...
  {"items":
   [("nla.click_select",
    ...
    ("nla.select_all", {"type": 'LEFTMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ],
   },
  ),
 ("Sequencer",
