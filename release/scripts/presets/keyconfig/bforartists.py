...
kmi = km.keymap_items.new('object.mode_set', 'ESC', 'PRESS')
...
kmi = km.keymap_items.new('mesh.select_mode', 'NONE', 'PRESS')
...
kmi = km.keymap_items.new('text.select_line', 'A', 'PRESS', shift=True)
