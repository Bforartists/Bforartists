...
kmi = km.keymap_items.new('mesh.select_mode', 'Y', 'PRESS')
...
kmi = km.keymap_items.new('mesh.delete', 'DEL', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'type', 'VERT')
kmi = km.keymap_items.new('mesh.delete', 'DEL', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'type', 'EDGE')
kmi = km.keymap_items.new('mesh.delete', 'DEL', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'type', 'FACE')
...
kmi = km.keymap_items.new('mesh.dupli_extrude_cursor_norotate', 'ACTIONMOUSE', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('mesh.dupli_extrude_cursor_rotate', 'ACTIONMOUSE', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('view3d.zoom_border', 'Q', 'PRESS')
...
kmi = km.keymap_items.new('object.subdivision_set', 'FIVE', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'level', 5)
kmi = km.keymap_items.new('object.select_hierarchy', 'H', 'PRESS')
...
kmi = km.keymap_items.new('text.save_as', 'S', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('text.run_script', 'F1', 'PRESS')
...
kmi = km.keymap_items.new('text.select_line', 'A', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('view2d.zoom_border', 'Q', 'PRESS')
...
kmi = km.keymap_items.new('nla.tweakmode_enter', 'A', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'isolate_action', True)
...
kmi_props_setattr(kmi.properties, 'mode', 'TIME_SCALE')
kmi = km.keymap_items.new('transform.translate', 'W', 'PRESS')
kmi = km.keymap_items.new('nla.fmodifier_add', 'NONE', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'GENERATOR')
...
kmi = km.keymap_items.new('sequencer.view_zoom_ratio', 'G', 'PRESS')
