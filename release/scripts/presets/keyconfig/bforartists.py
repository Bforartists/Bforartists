...
kmi = km.keymap_items.new('clip.view_selected', 'D', 'PRESS')
...
kmi = km.keymap_items.new('view3d.view_selected', 'D', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'use_all_regions', True)
kmi = km.keymap_items.new('view3d.view_selected', 'D', 'PRESS')
...
kmi = km.keymap_items.new('sequencer.view_selected', 'D', 'PRESS')
...
kmi = km.keymap_items.new('node.view_selected', 'D', 'PRESS')
...
kmi = km.keymap_items.new('nla.view_selected', 'D', 'PRESS')
...
kmi = km.keymap_items.new('graph.view_selected', 'D', 'PRESS')
...
kmi = km.keymap_items.new('action.view_selected', 'D', 'PRESS')
