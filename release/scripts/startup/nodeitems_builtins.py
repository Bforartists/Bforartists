...
shader_node_categories = [
    ...
    ShaderNodeCategory("SH_NEW_INPUT", "Input", items=[
        NodeItem("ShaderNodeTexCoord", icon = "NODE_TEXCOORDINATE"),
        NodeItem("ShaderNodeAttribute", icon = "NODE_ATTRIBUTE"),
        NodeItem("ShaderNodeLightPath", icon = "NODE_LIGHTPATH"),
        NodeItem("ShaderNodeFresnel", icon = "NODE_FRESNEL"),
        NodeItem("ShaderNodeLayerWeight", icon = "NODE_LAYERWEIGHT"),
        NodeItem("ShaderNodeRGB", icon = "NODE_RGB"),
        NodeItem("ShaderNodeValue", icon = "NODE_VALUE"),
        NodeItem("ShaderNodeTangent", icon = "NODE_TANGENT"),
        NodeItem("ShaderNodeNewGeometry", icon = "NODE_GEOMETRY"),
        NodeItem("ShaderNodeWireframe", icon = "NODE_WIREFRAME"),
