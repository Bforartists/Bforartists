...
# This is the Bforartists version of this script
...
def register():
    ...
    bpy.types.NODE_MT_add.prepend(attr_nodes_menu_func)
    bpy.types.NODE_PT_backdrop.append(bgreset_menu_func)
    bpy.types.NODE_PT_active_node_generic.append(save_viewer_menu_func)
    bpy.types.NODE_MT_add.prepend(multipleimages_menu_func)
